...
CREATE TABLE import_expression (
	...
	broad_mappings TEXT, 
	rank INTEGER, 
	PRIMARY KEY (import_from, import_as, import_map, extensions, annotations, description, alt_descriptions, title, deprecated, todos, notes, comments, examples, in_subset, from_schema, imported_from, source, in_language, see_also, deprecated_element_has_exact_replacement, deprecated_element_has_possible_replacement, aliases, structured_aliases, mappings, exact_mappings, close_mappings, related_mappings, narrow_mappings, broad_mappings, rank)
);
...
CREATE TABLE "UnitOfMeasure" (
	...
	iec61360code TEXT, 
	PRIMARY KEY (symbol, exact_mappings, ucum_code, derivation, has_quantity_kind, iec61360code)
);
...
CREATE TABLE unique_key (
	...
	rank INTEGER, 
	class_definition_name TEXT, 
	PRIMARY KEY (unique_key_name, unique_key_slots, extensions, annotations, description, alt_descriptions, title, deprecated, todos, notes, comments, examples, in_subset, from_schema, imported_from, source, in_language, see_also, deprecated_element_has_exact_replacement, deprecated_element_has_possible_replacement, aliases, structured_aliases, mappings, exact_mappings, close_mappings, related_mappings, narrow_mappings, broad_mappings, rank, class_definition_name), 
	FOREIGN KEY(class_definition_name) REFERENCES class_definition (name)
);
