...
class Phenopacket(YAMLRoot):
    ...
    phenotypicFeatures: Optional[Union[Union[dict, "PhenotypicFeature"], list[Union[dict, "PhenotypicFeature"]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        self.interpretations = [
            v if isinstance(v, Interpretation) else Interpretation(**as_dict(v)) for v in self.interpretations
        ]
        ...
        self.medicalActions = [
            v if isinstance(v, MedicalAction) else MedicalAction(**as_dict(v)) for v in self.medicalActions
        ]
        ...
        self.phenotypicFeatures = [
            v if isinstance(v, PhenotypicFeature) else PhenotypicFeature(**as_dict(v)) for v in self.phenotypicFeatures
        ]
...
class File(YAMLRoot):
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        if self.individualToFileIdentifiers is not None and not isinstance(
...
class Biosample(YAMLRoot):
    ...
    description: Optional[str] = None
    diagnosticMarkers: Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ] = empty_dict()
    files: Optional[Union[Union[dict, File], list[Union[dict, File]]]] = empty_list()
    ...
    pathologicalTnmFinding: Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ] = empty_dict()
    phenotypicFeatures: Optional[Union[Union[dict, "PhenotypicFeature"], list[Union[dict, "PhenotypicFeature"]]]] = (
        empty_list()
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="diagnosticMarkers", slot_type=OntologyClass, key_name="id", keyed=True
        )
        ...
        self._normalize_inlined_as_dict(
            slot_name="pathologicalTnmFinding", slot_type=OntologyClass, key_name="id", keyed=True
        )
...
class Disease(YAMLRoot):
    ...
    clinicalTnmFinding: Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ] = empty_dict()
    diseaseStage: Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ] = empty_dict()
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        self._normalize_inlined_as_dict(
            slot_name="clinicalTnmFinding", slot_type=OntologyClass, key_name="id", keyed=True
        )
...
class Diagnosis(YAMLRoot):
    ...
    genomicInterpretations: Optional[
        Union[Union[dict, "GenomicInterpretation"], list[Union[dict, "GenomicInterpretation"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        if not isinstance(self.genomicInterpretations, list):
            self.genomicInterpretations = (
                [self.genomicInterpretations] if self.genomicInterpretations is not None else []
            )
        self.genomicInterpretations = [
            v if isinstance(v, GenomicInterpretation) else GenomicInterpretation(**as_dict(v))
            for v in self.genomicInterpretations
        ]
...
class VariantInterpretation(YAMLRoot):
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        if self.acmgPathogenicityClassification is not None and not isinstance(
            self.acmgPathogenicityClassification, AcmgPathogenicityClassification
        ):
            self.acmgPathogenicityClassification = AcmgPathogenicityClassification(self.acmgPathogenicityClassification)

        if self.therapeuticActionability is not None and not isinstance(
...
class MedicalAction(YAMLRoot):
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        if self.treatmentTerminationReason is not None and not isinstance(
            self.treatmentTerminationReason, OntologyClass
        ):
...
class Treatment(YAMLRoot):
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        self.doseIntervals = [
            v if isinstance(v, DoseInterval) else DoseInterval(**as_dict(v)) for v in self.doseIntervals
        ]
...
class MetaData(YAMLRoot):
    ...
    externalReferences: Optional[Union[Union[dict, ExternalReference], list[Union[dict, ExternalReference]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        self.externalReferences = [
            v if isinstance(v, ExternalReference) else ExternalReference(**as_dict(v)) for v in self.externalReferences
        ]
...
class Allele(YAMLRoot):
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        if self.derivedSequenceExpression is not None and not isinstance(
            self.derivedSequenceExpression, DerivedSequenceExpression
        ):
        ...
        if self.literalSequenceExpression is not None and not isinstance(
            self.literalSequenceExpression, LiteralSequenceExpression
        ):
            self.literalSequenceExpression = LiteralSequenceExpression(**as_dict(self.literalSequenceExpression))

        if self.repeatedSequenceExpression is not None and not isinstance(
            self.repeatedSequenceExpression, RepeatedSequenceExpression
        ):
...
class Sex(EnumDefinitionImpl):
    ...
    OTHER_SEX = PermissibleValue(
        text="OTHER_SEX", description="It is not possible, to accurately assess the applicability of MALE/FEMALE."
    )
    UNKNOWN_SEX = PermissibleValue(text="UNKNOWN_SEX", description="Not assessed / available.")
...
class AllelicStateTerms(EnumDefinitionImpl):
    ...
    HETEROZYGOUS = PermissibleValue(text="HETEROZYGOUS", description="heterozygous", meaning=GENO["0000135"])
    HOMOZYGOUS = PermissibleValue(text="HOMOZYGOUS", description="homozygous", meaning=GENO["0000136"])
    HEMIZYGOUS = PermissibleValue(text="HEMIZYGOUS", description="hemizygous", meaning=GENO["0000134"])
...
class AssaysTerms(EnumDefinitionImpl):
    ...
    CREATINE_KINASE = PermissibleValue(
        text="CREATINE_KINASE",
...
class GenderTerms(EnumDefinitionImpl):
    ...
    IDENTIFIES_AS_MALE = PermissibleValue(
        text="IDENTIFIES_AS_MALE", description="Identifies as male", meaning=LOINC["LA22878-5"]
    )
    IDENTIFIES_AS_FEMALE = PermissibleValue(
        text="IDENTIFIES_AS_FEMALE", description="Identifies as female", meaning=LOINC["LA22879-3"]
    )
    FEMALE_TO_MALE_TRANSSEXUAL = PermissibleValue(
        text="FEMALE_TO_MALE_TRANSSEXUAL", description="Female-to-male transsexual", meaning=LOINC["LA22880-1"]
    )
    MALE_TO_FEMALE_TRANSSEXUAL = PermissibleValue(
        text="MALE_TO_FEMALE_TRANSSEXUAL", description="Male-to-female transsexual", meaning=LOINC["LA22881-9"]
    )
    IDENTIFIES_AS_NON_CONFORMING = PermissibleValue(
        text="IDENTIFIES_AS_NON_CONFORMING", description="Identifies as non-conforming", meaning=LOINC["LA22882-7"]
    )
    OTHER_GENDER = PermissibleValue(text="OTHER_GENDER", description="other", meaning=LOINC["LA46-8"])
    ASKED_BUT_UNKNOWN = PermissibleValue(
        text="ASKED_BUT_UNKNOWN", description="Asked but unknown", meaning=LOINC["LA20384-6"]
    )
...
class LateralityTerms(EnumDefinitionImpl):
    ...
    RIGHT = PermissibleValue(text="RIGHT", description="Right", meaning=HP["0012834"])
    LEFT = PermissibleValue(text="LEFT", description="Left", meaning=HP["0012835"])
    UNILATERAL = PermissibleValue(text="UNILATERAL", description="Unilateral", meaning=HP["0012833"])
    BILATERAL = PermissibleValue(text="BILATERAL", description="Bilateral", meaning=HP["0012832"])
...
class MedicalActionsTerms(EnumDefinitionImpl):
    ...
    ADVERSE_EVENT = PermissibleValue(text="ADVERSE_EVENT", description="Adverse Event", meaning=NCIT.C41331)
    FOUR_TIMES_DAILY = PermissibleValue(text="FOUR_TIMES_DAILY", description="Four Times Daily", meaning=NCIT.C64530)
    INTRA_ARTERIAL = PermissibleValue(
        text="INTRA_ARTERIAL", description="Intraarterial Route of Administration", meaning=NCIT.C38222
    )
    IV_ADMINISTRATION = PermissibleValue(
        text="IV_ADMINISTRATION", description="Intravenous Route of Administration", meaning=NCIT.C38276
    )
    ORAL_ADMINISTRATION = PermissibleValue(
        text="ORAL_ADMINISTRATION", description="Oral Route of Administration", meaning=NCIT.C38288
    )
    ONCE = PermissibleValue(text="ONCE", description="Once", meaning=NCIT.C64576)
    ONCE_DAILY = PermissibleValue(text="ONCE_DAILY", description="Once Daily", meaning=NCIT.C125004)
    THREE_TIMES_DAILY = PermissibleValue(text="THREE_TIMES_DAILY", description="Three Times Daily", meaning=NCIT.C64527)
    TWICE_DAILY = PermissibleValue(text="TWICE_DAILY", description="Twice Daily", meaning=NCIT.C64496)
...
class OnsetTerms(EnumDefinitionImpl):
    ...
    ANTENATAL_ONSET = PermissibleValue(text="ANTENATAL_ONSET", description="Antenatal onset", meaning=HP["0030674"])
    EMBRYONAL_ONSET = PermissibleValue(text="EMBRYONAL_ONSET", description="Embryonal onset", meaning=HP["0011460"])
    FETAL_ONSET = PermissibleValue(text="FETAL_ONSET", description="Fetal onset", meaning=HP["0011461"])
    LATE_FIRST_TRIMESTER_ONSET = PermissibleValue(
        text="LATE_FIRST_TRIMESTER_ONSET", description="Late first trimester onset", meaning=HP["0034199"]
    )
    SECOND_TRIMESTER_ONSET = PermissibleValue(
        text="SECOND_TRIMESTER_ONSET", description="Second trimester onset", meaning=HP["0034198"]
    )
    THIRD_TRIMESTER_ONSET = PermissibleValue(
        text="THIRD_TRIMESTER_ONSET", description="Third trimester onset", meaning=HP["0034197"]
    )
    CONGENITAL_ONSET = PermissibleValue(text="CONGENITAL_ONSET", description="Congenital onset", meaning=HP["0003577"])
    NEONATAL_ONSET = PermissibleValue(text="NEONATAL_ONSET", description="Neonatal onset", meaning=HP["0003623"])
    INFANTILE_ONSET = PermissibleValue(text="INFANTILE_ONSET", description="Infantile onset", meaning=HP["0003593"])
    CHILDHOOD_ONSET = PermissibleValue(text="CHILDHOOD_ONSET", description="Childhood onset", meaning=HP["0011463"])
    JUVENILE_ONSET = PermissibleValue(text="JUVENILE_ONSET", description="Juvenile onset", meaning=HP["0003621"])
    ADULT_ONSET = PermissibleValue(text="ADULT_ONSET", description="Adult onset", meaning=HP["0003581"])
    YOUNG_ADULT_ONSET = PermissibleValue(
        text="YOUNG_ADULT_ONSET", description="Young adult onset", meaning=HP["0011462"]
    )
    EARLY_YOUNG_ADULT_ONSET = PermissibleValue(
        text="EARLY_YOUNG_ADULT_ONSET", description="Early young adult onset", meaning=HP["0025708"]
    )
    INTERMEDIATE_YOUNG_ADULT_ONSET = PermissibleValue(
        text="INTERMEDIATE_YOUNG_ADULT_ONSET", description="Intermediate young adult onset", meaning=HP["0025709"]
    )
    LATE_YOUNG_ADULT_ONSET = PermissibleValue(
        text="LATE_YOUNG_ADULT_ONSET", description="Late young adult onset", meaning=HP["0025710"]
    )
    MIDDLE_AGE_ONSET = PermissibleValue(text="MIDDLE_AGE_ONSET", description="Middle age onset", meaning=HP["0003596"])
    LATE_ONSET = PermissibleValue(text="LATE_ONSET", description="Late onset", meaning=HP["0003584"])
...
class OrganTerms(EnumDefinitionImpl):
    ...
    BRAIN = PermissibleValue(text="BRAIN", description="brain", meaning=UBERON["0000955"])
    CEREBELLUM = PermissibleValue(text="CEREBELLUM", description="cerebellum", meaning=UBERON["0002037"])
    EAR = PermissibleValue(text="EAR", description="ear", meaning=UBERON["0001690"])
    EYE = PermissibleValue(text="EYE", description="eye", meaning=UBERON["0000970"])
    HEART = PermissibleValue(text="HEART", description="heart", meaning=UBERON["0002107"])
    KIDNEY = PermissibleValue(text="KIDNEY", description="kidney", meaning=UBERON["0002113"])
    LARGE_INTESTINE = PermissibleValue(text="LARGE_INTESTINE", description="large intestine", meaning=UBERON["0000059"])
    LIVER = PermissibleValue(text="LIVER", description="liver", meaning=UBERON["0002107"])
    LUNG = PermissibleValue(text="LUNG", description="lung", meaning=UBERON["0002048"])
    NOSE = PermissibleValue(text="NOSE", description="nose", meaning=UBERON["0000004"])
    SMALL_INTESTINE = PermissibleValue(text="SMALL_INTESTINE", description="small intestine", meaning=UBERON["0002108"])
    SPINAL_CORD = PermissibleValue(text="SPINAL_CORD", description="spinal cord", meaning=UBERON["0002240"])
    SPLEEN = PermissibleValue(text="SPLEEN", description="spleen", meaning=UBERON["0002106"])
    TONGUE = PermissibleValue(text="TONGUE", description="tongue", meaning=UBERON["0001723"])
    THYMUS = PermissibleValue(text="THYMUS", description="thymus", meaning=UBERON["0002370"])
...
class ResponseTerms(EnumDefinitionImpl):
    ...
    FAVORABLE = PermissibleValue(text="FAVORABLE", description="Favorable", meaning=NCIT.C102560)
    UNFAVORABLE = PermissibleValue(text="UNFAVORABLE", description="Unfavorable", meaning=NCIT.C102561)
...
class SpatialPatternTerms(EnumDefinitionImpl):
    ...
    PREDOMINANT_SMALL_JOINT_LOCALIZATION = PermissibleValue(
        text="PREDOMINANT_SMALL_JOINT_LOCALIZATION",
        description="Predominant small joint localization",
        meaning=HP["0032544"],
    )
    POLYCYCLIC = PermissibleValue(text="POLYCYCLIC", description="Polycyclic", meaning=HP["0031450"])
    AXIAL = PermissibleValue(text="AXIAL", description="Axial", meaning=HP["0025287"])
    PERILOBULAR = PermissibleValue(text="PERILOBULAR", description="Perilobular", meaning=HP["0033813"])
    PARASEPTAL = PermissibleValue(text="PARASEPTAL", description="Paraseptal", meaning=HP["0033814"])
    BRONCHOCENTRIC = PermissibleValue(text="BRONCHOCENTRIC", description="Bronchocentric", meaning=HP["0033815"])
    CENTRILOBULAR = PermissibleValue(text="CENTRILOBULAR", description="Centrilobular", meaning=HP["0033816"])
    MILIARY = PermissibleValue(text="MILIARY", description="Miliary", meaning=HP["0033817"])
    GENERALIZED = PermissibleValue(text="GENERALIZED", description="Generalized", meaning=HP["0012837"])
    PERILYMPHATIC = PermissibleValue(text="PERILYMPHATIC", description="Perilymphatic", meaning=HP["0033819"])
    LOCALIZED = PermissibleValue(text="LOCALIZED", description="Localized", meaning=HP["0012838"])
    RETICULAR = PermissibleValue(text="RETICULAR", description="Reticular", meaning=HP["0033818"])
    DISTAL = PermissibleValue(text="DISTAL", description="Distal", meaning=HP["0012839"])
    CENTRAL = PermissibleValue(text="CENTRAL", description="Central", meaning=HP["0030645"])
    UPPER_BODY_PREDOMINANCE = PermissibleValue(
        text="UPPER_BODY_PREDOMINANCE", description="Upper-body predominance", meaning=HP["0025290"]
    )
    JOINT_EXTENSOR_SURFACE_LOCALIZATION = PermissibleValue(
        text="JOINT_EXTENSOR_SURFACE_LOCALIZATION",
        description="Joint extensor surface localization",
        meaning=HP["0032539"],
    )
    HERPETIFORM = PermissibleValue(text="HERPETIFORM", description="Herpetiform", meaning=HP["0025295"])
    MORBILLIFORM = PermissibleValue(text="MORBILLIFORM", description="Morbilliform", meaning=HP["0025296"])
    PERICENTRAL = PermissibleValue(text="PERICENTRAL", description="Pericentral", meaning=HP["0030649"])
    DERMATOMAL = PermissibleValue(text="DERMATOMAL", description="Dermatomal", meaning=HP["0025294"])
    MIDPERIPHERAL = PermissibleValue(text="MIDPERIPHERAL", description="Midperipheral", meaning=HP["0030648"])
    DISTRIBUTED_ALONG_BLASCHKO_LINES = PermissibleValue(
        text="DISTRIBUTED_ALONG_BLASCHKO_LINES", description="Distributed along Blaschko lines", meaning=HP["0025293"]
    )
    ACRAL = PermissibleValue(text="ACRAL", description="Acral", meaning=HP["0025292"])
    PARACENTRAL = PermissibleValue(text="PARACENTRAL", description="Paracentral", meaning=HP["0030647"])
    LATERAL = PermissibleValue(text="LATERAL", description="Lateral", meaning=HP["0025275"])
    PERIPHERAL = PermissibleValue(text="PERIPHERAL", description="Peripheral", meaning=HP["0030646"])
    LOWER_BODY_PREDOMINANCE = PermissibleValue(
        text="LOWER_BODY_PREDOMINANCE", description="Lower-body predominance", meaning=HP["0025291"]
    )
    DIFFUSE = PermissibleValue(text="DIFFUSE", description="Diffuse", meaning=HP["0020034"])
    PROXIMAL = PermissibleValue(text="PROXIMAL", description="Proximal", meaning=HP["0012840"])
    APICAL = PermissibleValue(text="APICAL", description="Apical", meaning=HP["0033820"])
    FOCAL = PermissibleValue(text="FOCAL", description="Focal", meaning=HP["0030650"])
    MULTIFOCAL = PermissibleValue(text="MULTIFOCAL", description="Multifocal", meaning=HP["0030651"])
    JOINT_FLEXOR_SURFACE_LOCALIZATION = PermissibleValue(
        text="JOINT_FLEXOR_SURFACE_LOCALIZATION", description="Jointflexorsurfacelocalization", meaning=HP["0032540"]
    )
...
class UnitTerms(EnumDefinitionImpl):
    ...
    DEGREE = PermissibleValue(text="DEGREE", description="degree (plane angle)", meaning=UCUM.degree)
    DIOPTER = PermissibleValue(text="DIOPTER", description="diopter", meaning=UCUM["%5Bdiop%5D"])
    GRAM = PermissibleValue(text="GRAM", description="gram", meaning=UCUM.g)
    GRAM_PER_KG = PermissibleValue(text="GRAM_PER_KG", description="gram per kilogram", meaning=UCUM["g/kg"])
    KILIGRAM = PermissibleValue(text="KILIGRAM", description="kiligram", meaning=UCUM.kg)
    LITER = PermissibleValue(text="LITER", description="liter", meaning=UCUM.L)
    METER = PermissibleValue(text="METER", description="meter", meaning=UCUM.m)
    MICROGRAM = PermissibleValue(text="MICROGRAM", description="microgram", meaning=UCUM.ug)
    MICROGRAM_PER_DECILITER = PermissibleValue(
        text="MICROGRAM_PER_DECILITER", description="microgram per deciliter", meaning=UCUM["ug/dL"]
    )
    MICROGRAM_PER_LITER = PermissibleValue(
        text="MICROGRAM_PER_LITER", description="microgram per liter", meaning=UCUM["ug/L"]
    )
    MICROLITER = PermissibleValue(text="MICROLITER", description="microliter", meaning=UCUM.uL)
    MICROMETER = PermissibleValue(text="MICROMETER", description="micrometer", meaning=UCUM.um)
    MILLIGRAM = PermissibleValue(text="MILLIGRAM", description="milligram", meaning=UCUM.mg)
    MILLIGRAM_PER_DAY = PermissibleValue(
        text="MILLIGRAM_PER_DAY", description="milligram per day", meaning=UCUM["mg/dL"]
    )
    MILLIGRAM_PER_DL = PermissibleValue(
        text="MILLIGRAM_PER_DL", description="milligram per deciliter", meaning=UCUM["mg/dL"]
    )
    MILLIGRAM_PER_KG = PermissibleValue(
        text="MILLIGRAM_PER_KG", description="milligram per kilogram", meaning=UCUM["mg.kg-1"]
    )
    MILLILITER = PermissibleValue(text="MILLILITER", description="milliliter", meaning=UCUM.mL)
    MILLIMETER = PermissibleValue(text="MILLIMETER", description="millimeter", meaning=UCUM.mm)
    MILLIMETRES_OF_MERCURY = PermissibleValue(
        text="MILLIMETRES_OF_MERCURY", description="millimetres of mercury", meaning=UCUM["mm%5BHg%5D"]
    )
    MILLIMOLE = PermissibleValue(text="MILLIMOLE", description="millimole", meaning=UCUM.mmol)
    MOLE = PermissibleValue(text="MOLE", description="mole", meaning=UCUM.mol)
    MOLE_PER_LITER = PermissibleValue(text="MOLE_PER_LITER", description="mole per liter", meaning=UCUM["mol/L"])
    MOLE_PER_MILLILITER = PermissibleValue(
        text="MOLE_PER_MILLILITER", description="mole per milliliter", meaning=UCUM["mol/mL"]
    )
    ENZYME_UNIT_PER_LITER = PermissibleValue(
        text="ENZYME_UNIT_PER_LITER", description="enzyme unit per liter", meaning=UCUM["U/L"]
    )
...
slots.cohort__description = Slot(
    uri=PHENOPACKETS.description,
    name="cohort__description",
    curie=PHENOPACKETS.curie("description"),
    model_uri=PHENOPACKETS.cohort__description,
    domain=None,
    range=Optional[str],
)

slots.cohort__files = Slot(
    uri=PHENOPACKETS.files,
    name="cohort__files",
    curie=PHENOPACKETS.curie("files"),
    model_uri=PHENOPACKETS.cohort__files,
    domain=None,
    range=Optional[Union[Union[dict, File], list[Union[dict, File]]]],
)

slots.cohort__id = Slot(
    uri=PHENOPACKETS.id,
    name="cohort__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.cohort__id,
    domain=None,
    range=Optional[str],
)

slots.cohort__members = Slot(
    uri=PHENOPACKETS.members,
    name="cohort__members",
    curie=PHENOPACKETS.curie("members"),
    model_uri=PHENOPACKETS.cohort__members,
    domain=None,
    range=Optional[Union[Union[dict, Phenopacket], list[Union[dict, Phenopacket]]]],
)

slots.cohort__metaData = Slot(
    uri=PHENOPACKETS.metaData,
    name="cohort__metaData",
    curie=PHENOPACKETS.curie("metaData"),
    model_uri=PHENOPACKETS.cohort__metaData,
    domain=None,
    range=Union[dict, MetaData],
)

slots.family__consanguinousParents = Slot(
    uri=PHENOPACKETS.consanguinousParents,
    name="family__consanguinousParents",
    curie=PHENOPACKETS.curie("consanguinousParents"),
    model_uri=PHENOPACKETS.family__consanguinousParents,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.family__files = Slot(
    uri=PHENOPACKETS.files,
    name="family__files",
    curie=PHENOPACKETS.curie("files"),
    model_uri=PHENOPACKETS.family__files,
    domain=None,
    range=Optional[Union[Union[dict, File], list[Union[dict, File]]]],
)

slots.family__id = Slot(
    uri=PHENOPACKETS.id,
    name="family__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.family__id,
    domain=None,
    range=Optional[str],
)

slots.family__metaData = Slot(
    uri=PHENOPACKETS.metaData,
    name="family__metaData",
    curie=PHENOPACKETS.curie("metaData"),
    model_uri=PHENOPACKETS.family__metaData,
    domain=None,
    range=Union[dict, MetaData],
)

slots.family__pedigree = Slot(
    uri=PHENOPACKETS.pedigree,
    name="family__pedigree",
    curie=PHENOPACKETS.curie("pedigree"),
    model_uri=PHENOPACKETS.family__pedigree,
    domain=None,
    range=Optional[Union[dict, Pedigree]],
)

slots.family__proband = Slot(
    uri=PHENOPACKETS.proband,
    name="family__proband",
    curie=PHENOPACKETS.curie("proband"),
    model_uri=PHENOPACKETS.family__proband,
    domain=None,
    range=Optional[Union[dict, Phenopacket]],
)

slots.family__relatives = Slot(
    uri=PHENOPACKETS.relatives,
    name="family__relatives",
    curie=PHENOPACKETS.curie("relatives"),
    model_uri=PHENOPACKETS.family__relatives,
    domain=None,
    range=Optional[Union[Union[dict, Phenopacket], list[Union[dict, Phenopacket]]]],
)

slots.phenopacket__biosamples = Slot(
    uri=PHENOPACKETS.biosamples,
    name="phenopacket__biosamples",
    curie=PHENOPACKETS.curie("biosamples"),
    model_uri=PHENOPACKETS.phenopacket__biosamples,
    domain=None,
    range=Optional[Union[Union[dict, Biosample], list[Union[dict, Biosample]]]],
)

slots.phenopacket__diseases = Slot(
    uri=PHENOPACKETS.diseases,
    name="phenopacket__diseases",
    curie=PHENOPACKETS.curie("diseases"),
    model_uri=PHENOPACKETS.phenopacket__diseases,
    domain=None,
    range=Optional[Union[Union[dict, Disease], list[Union[dict, Disease]]]],
)

slots.phenopacket__files = Slot(
    uri=PHENOPACKETS.files,
    name="phenopacket__files",
    curie=PHENOPACKETS.curie("files"),
    model_uri=PHENOPACKETS.phenopacket__files,
    domain=None,
    range=Optional[Union[Union[dict, File], list[Union[dict, File]]]],
)

slots.phenopacket__id = Slot(
    uri=PHENOPACKETS.id,
    name="phenopacket__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.phenopacket__id,
    domain=None,
    range=Optional[str],
)

slots.phenopacket__interpretations = Slot(
    uri=PHENOPACKETS.interpretations,
    name="phenopacket__interpretations",
    curie=PHENOPACKETS.curie("interpretations"),
    model_uri=PHENOPACKETS.phenopacket__interpretations,
    domain=None,
    range=Optional[Union[Union[dict, Interpretation], list[Union[dict, Interpretation]]]],
)

slots.phenopacket__measurements = Slot(
    uri=PHENOPACKETS.measurements,
    name="phenopacket__measurements",
    curie=PHENOPACKETS.curie("measurements"),
    model_uri=PHENOPACKETS.phenopacket__measurements,
    domain=None,
    range=Optional[Union[Union[dict, Measurement], list[Union[dict, Measurement]]]],
)

slots.phenopacket__medicalActions = Slot(
    uri=PHENOPACKETS.medicalActions,
    name="phenopacket__medicalActions",
    curie=PHENOPACKETS.curie("medicalActions"),
    model_uri=PHENOPACKETS.phenopacket__medicalActions,
    domain=None,
    range=Optional[Union[Union[dict, MedicalAction], list[Union[dict, MedicalAction]]]],
)

slots.phenopacket__metaData = Slot(
    uri=PHENOPACKETS.metaData,
    name="phenopacket__metaData",
    curie=PHENOPACKETS.curie("metaData"),
    model_uri=PHENOPACKETS.phenopacket__metaData,
    domain=None,
    range=Union[dict, MetaData],
)

slots.phenopacket__phenotypicFeatures = Slot(
    uri=PHENOPACKETS.phenotypicFeatures,
    name="phenopacket__phenotypicFeatures",
    curie=PHENOPACKETS.curie("phenotypicFeatures"),
    model_uri=PHENOPACKETS.phenopacket__phenotypicFeatures,
    domain=None,
    range=Optional[Union[Union[dict, PhenotypicFeature], list[Union[dict, PhenotypicFeature]]]],
)

slots.phenopacket__subject = Slot(
    uri=PHENOPACKETS.subject,
    name="phenopacket__subject",
    curie=PHENOPACKETS.curie("subject"),
    model_uri=PHENOPACKETS.phenopacket__subject,
    domain=None,
    range=Optional[Union[dict, Individual]],
)

slots.age__iso8601duration = Slot(
    uri=PHENOPACKETS.iso8601duration,
    name="age__iso8601duration",
    curie=PHENOPACKETS.curie("iso8601duration"),
    model_uri=PHENOPACKETS.age__iso8601duration,
    domain=None,
    range=Optional[str],
)

slots.ageRange__end = Slot(
    uri=PHENOPACKETS.end,
    name="ageRange__end",
    curie=PHENOPACKETS.curie("end"),
    model_uri=PHENOPACKETS.ageRange__end,
    domain=None,
    range=Optional[Union[dict, Age]],
)

slots.ageRange__start = Slot(
    uri=PHENOPACKETS.start,
    name="ageRange__start",
    curie=PHENOPACKETS.curie("start"),
    model_uri=PHENOPACKETS.ageRange__start,
    domain=None,
    range=Optional[Union[dict, Age]],
)

slots.evidence__evidenceCode = Slot(
    uri=PHENOPACKETS.evidenceCode,
    name="evidence__evidenceCode",
    curie=PHENOPACKETS.curie("evidenceCode"),
    model_uri=PHENOPACKETS.evidence__evidenceCode,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.evidence__reference = Slot(
    uri=PHENOPACKETS.reference,
    name="evidence__reference",
    curie=PHENOPACKETS.curie("reference"),
    model_uri=PHENOPACKETS.evidence__reference,
    domain=None,
    range=Optional[Union[dict, ExternalReference]],
)

slots.externalReference__description = Slot(
    uri=PHENOPACKETS.description,
    name="externalReference__description",
    curie=PHENOPACKETS.curie("description"),
    model_uri=PHENOPACKETS.externalReference__description,
    domain=None,
    range=Optional[str],
)

slots.externalReference__id = Slot(
    uri=PHENOPACKETS.id,
    name="externalReference__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.externalReference__id,
    domain=None,
    range=Optional[str],
)

slots.externalReference__reference = Slot(
    uri=PHENOPACKETS.reference,
    name="externalReference__reference",
    curie=PHENOPACKETS.curie("reference"),
    model_uri=PHENOPACKETS.externalReference__reference,
    domain=None,
    range=Optional[str],
)

slots.file__fileAttributes = Slot(
    uri=PHENOPACKETS.fileAttributes,
    name="file__fileAttributes",
    curie=PHENOPACKETS.curie("fileAttributes"),
    model_uri=PHENOPACKETS.file__fileAttributes,
    domain=None,
    range=Optional[Union[dict, Dictionary]],
)

slots.file__individualToFileIdentifiers = Slot(
    uri=PHENOPACKETS.individualToFileIdentifiers,
    name="file__individualToFileIdentifiers",
    curie=PHENOPACKETS.curie("individualToFileIdentifiers"),
    model_uri=PHENOPACKETS.file__individualToFileIdentifiers,
    domain=None,
    range=Optional[Union[dict, Dictionary]],
)

slots.file__uri = Slot(
    uri=PHENOPACKETS.uri,
    name="file__uri",
    curie=PHENOPACKETS.curie("uri"),
    model_uri=PHENOPACKETS.file__uri,
    domain=None,
    range=Optional[str],
)

slots.gestationalAge__days = Slot(
    uri=PHENOPACKETS.days,
    name="gestationalAge__days",
    curie=PHENOPACKETS.curie("days"),
    model_uri=PHENOPACKETS.gestationalAge__days,
    domain=None,
    range=Optional[int],
)

slots.gestationalAge__weeks = Slot(
    uri=PHENOPACKETS.weeks,
    name="gestationalAge__weeks",
    curie=PHENOPACKETS.curie("weeks"),
    model_uri=PHENOPACKETS.gestationalAge__weeks,
    domain=None,
    range=Optional[int],
)

slots.ontologyClass__id = Slot(
    uri=PHENOPACKETS.id,
    name="ontologyClass__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.ontologyClass__id,
    domain=None,
    range=URIRef,
)

slots.ontologyClass__label = Slot(
    uri=PHENOPACKETS.label,
    name="ontologyClass__label",
    curie=PHENOPACKETS.curie("label"),
    model_uri=PHENOPACKETS.ontologyClass__label,
    domain=None,
    range=Optional[str],
)

slots.procedure__bodySite = Slot(
    uri=PHENOPACKETS.bodySite,
    name="procedure__bodySite",
    curie=PHENOPACKETS.curie("bodySite"),
    model_uri=PHENOPACKETS.procedure__bodySite,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.procedure__code = Slot(
    uri=PHENOPACKETS.code,
    name="procedure__code",
    curie=PHENOPACKETS.curie("code"),
    model_uri=PHENOPACKETS.procedure__code,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.procedure__performed = Slot(
    uri=PHENOPACKETS.performed,
    name="procedure__performed",
    curie=PHENOPACKETS.curie("performed"),
    model_uri=PHENOPACKETS.procedure__performed,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.timeElement__age = Slot(
    uri=PHENOPACKETS.age,
    name="timeElement__age",
    curie=PHENOPACKETS.curie("age"),
    model_uri=PHENOPACKETS.timeElement__age,
    domain=None,
    range=Optional[Union[dict, Age]],
)

slots.timeElement__ageRange = Slot(
    uri=PHENOPACKETS.ageRange,
    name="timeElement__ageRange",
    curie=PHENOPACKETS.curie("ageRange"),
    model_uri=PHENOPACKETS.timeElement__ageRange,
    domain=None,
    range=Optional[Union[dict, AgeRange]],
)

slots.timeElement__gestationalAge = Slot(
    uri=PHENOPACKETS.gestationalAge,
    name="timeElement__gestationalAge",
    curie=PHENOPACKETS.curie("gestationalAge"),
    model_uri=PHENOPACKETS.timeElement__gestationalAge,
    domain=None,
    range=Optional[Union[dict, GestationalAge]],
)

slots.timeElement__interval = Slot(
    uri=PHENOPACKETS.interval,
    name="timeElement__interval",
    curie=PHENOPACKETS.curie("interval"),
    model_uri=PHENOPACKETS.timeElement__interval,
    domain=None,
    range=Optional[Union[dict, TimeInterval]],
)

slots.timeElement__ontologyClass = Slot(
    uri=PHENOPACKETS.ontologyClass,
    name="timeElement__ontologyClass",
    curie=PHENOPACKETS.curie("ontologyClass"),
    model_uri=PHENOPACKETS.timeElement__ontologyClass,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.timeElement__timestamp = Slot(
    uri=PHENOPACKETS.timestamp,
    name="timeElement__timestamp",
    curie=PHENOPACKETS.curie("timestamp"),
    model_uri=PHENOPACKETS.timeElement__timestamp,
    domain=None,
    range=Optional[str],
)

slots.timeInterval__end = Slot(
    uri=PHENOPACKETS.end,
    name="timeInterval__end",
    curie=PHENOPACKETS.curie("end"),
    model_uri=PHENOPACKETS.timeInterval__end,
    domain=None,
    range=Optional[str],
)

slots.timeInterval__start = Slot(
    uri=PHENOPACKETS.start,
    name="timeInterval__start",
    curie=PHENOPACKETS.curie("start"),
    model_uri=PHENOPACKETS.timeInterval__start,
    domain=None,
    range=Optional[str],
)

slots.biosample__derivedFromId = Slot(
    uri=PHENOPACKETS.derivedFromId,
    name="biosample__derivedFromId",
    curie=PHENOPACKETS.curie("derivedFromId"),
    model_uri=PHENOPACKETS.biosample__derivedFromId,
    domain=None,
    range=Optional[str],
)

slots.biosample__description = Slot(
    uri=PHENOPACKETS.description,
    name="biosample__description",
    curie=PHENOPACKETS.curie("description"),
    model_uri=PHENOPACKETS.biosample__description,
    domain=None,
    range=Optional[str],
)

slots.biosample__diagnosticMarkers = Slot(
    uri=PHENOPACKETS.diagnosticMarkers,
    name="biosample__diagnosticMarkers",
    curie=PHENOPACKETS.curie("diagnosticMarkers"),
    model_uri=PHENOPACKETS.biosample__diagnosticMarkers,
    domain=None,
    range=Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ],
...
slots.biosample__files = Slot(
    uri=PHENOPACKETS.files,
    name="biosample__files",
    curie=PHENOPACKETS.curie("files"),
    model_uri=PHENOPACKETS.biosample__files,
    domain=None,
    range=Optional[Union[Union[dict, File], list[Union[dict, File]]]],
)

slots.biosample__histologicalDiagnosis = Slot(
    uri=PHENOPACKETS.histologicalDiagnosis,
    name="biosample__histologicalDiagnosis",
    curie=PHENOPACKETS.curie("histologicalDiagnosis"),
    model_uri=PHENOPACKETS.biosample__histologicalDiagnosis,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__id = Slot(
    uri=PHENOPACKETS.id,
    name="biosample__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.biosample__id,
    domain=None,
    range=Optional[str],
)

slots.biosample__individualId = Slot(
    uri=PHENOPACKETS.individualId,
    name="biosample__individualId",
    curie=PHENOPACKETS.curie("individualId"),
    model_uri=PHENOPACKETS.biosample__individualId,
    domain=None,
    range=Optional[str],
)

slots.biosample__materialSample = Slot(
    uri=PHENOPACKETS.materialSample,
    name="biosample__materialSample",
    curie=PHENOPACKETS.curie("materialSample"),
    model_uri=PHENOPACKETS.biosample__materialSample,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__measurements = Slot(
    uri=PHENOPACKETS.measurements,
    name="biosample__measurements",
    curie=PHENOPACKETS.curie("measurements"),
    model_uri=PHENOPACKETS.biosample__measurements,
    domain=None,
    range=Optional[Union[Union[dict, Measurement], list[Union[dict, Measurement]]]],
)

slots.biosample__pathologicalStage = Slot(
    uri=PHENOPACKETS.pathologicalStage,
    name="biosample__pathologicalStage",
    curie=PHENOPACKETS.curie("pathologicalStage"),
    model_uri=PHENOPACKETS.biosample__pathologicalStage,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__pathologicalTnmFinding = Slot(
    uri=PHENOPACKETS.pathologicalTnmFinding,
    name="biosample__pathologicalTnmFinding",
    curie=PHENOPACKETS.curie("pathologicalTnmFinding"),
    model_uri=PHENOPACKETS.biosample__pathologicalTnmFinding,
    domain=None,
    range=Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ],
...
slots.biosample__phenotypicFeatures = Slot(
    uri=PHENOPACKETS.phenotypicFeatures,
    name="biosample__phenotypicFeatures",
    curie=PHENOPACKETS.curie("phenotypicFeatures"),
    model_uri=PHENOPACKETS.biosample__phenotypicFeatures,
    domain=None,
    range=Optional[Union[Union[dict, PhenotypicFeature], list[Union[dict, PhenotypicFeature]]]],
)

slots.biosample__procedure = Slot(
    uri=PHENOPACKETS.procedure,
    name="biosample__procedure",
    curie=PHENOPACKETS.curie("procedure"),
    model_uri=PHENOPACKETS.biosample__procedure,
    domain=None,
    range=Optional[Union[dict, Procedure]],
)

slots.biosample__sampleProcessing = Slot(
    uri=PHENOPACKETS.sampleProcessing,
    name="biosample__sampleProcessing",
    curie=PHENOPACKETS.curie("sampleProcessing"),
    model_uri=PHENOPACKETS.biosample__sampleProcessing,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__sampleStorage = Slot(
    uri=PHENOPACKETS.sampleStorage,
    name="biosample__sampleStorage",
    curie=PHENOPACKETS.curie("sampleStorage"),
    model_uri=PHENOPACKETS.biosample__sampleStorage,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__sampleType = Slot(
    uri=PHENOPACKETS.sampleType,
    name="biosample__sampleType",
    curie=PHENOPACKETS.curie("sampleType"),
    model_uri=PHENOPACKETS.biosample__sampleType,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__sampledTissue = Slot(
    uri=PHENOPACKETS.sampledTissue,
    name="biosample__sampledTissue",
    curie=PHENOPACKETS.curie("sampledTissue"),
    model_uri=PHENOPACKETS.biosample__sampledTissue,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__taxonomy = Slot(
    uri=PHENOPACKETS.taxonomy,
    name="biosample__taxonomy",
    curie=PHENOPACKETS.curie("taxonomy"),
    model_uri=PHENOPACKETS.biosample__taxonomy,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__timeOfCollection = Slot(
    uri=PHENOPACKETS.timeOfCollection,
    name="biosample__timeOfCollection",
    curie=PHENOPACKETS.curie("timeOfCollection"),
    model_uri=PHENOPACKETS.biosample__timeOfCollection,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.biosample__tumorGrade = Slot(
    uri=PHENOPACKETS.tumorGrade,
    name="biosample__tumorGrade",
    curie=PHENOPACKETS.curie("tumorGrade"),
    model_uri=PHENOPACKETS.biosample__tumorGrade,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.biosample__tumorProgression = Slot(
    uri=PHENOPACKETS.tumorProgression,
    name="biosample__tumorProgression",
    curie=PHENOPACKETS.curie("tumorProgression"),
    model_uri=PHENOPACKETS.biosample__tumorProgression,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.disease__clinicalTnmFinding = Slot(
    uri=PHENOPACKETS.clinicalTnmFinding,
    name="disease__clinicalTnmFinding",
    curie=PHENOPACKETS.curie("clinicalTnmFinding"),
    model_uri=PHENOPACKETS.disease__clinicalTnmFinding,
    domain=None,
    range=Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ],
...
slots.disease__diseaseStage = Slot(
    uri=PHENOPACKETS.diseaseStage,
    name="disease__diseaseStage",
    curie=PHENOPACKETS.curie("diseaseStage"),
    model_uri=PHENOPACKETS.disease__diseaseStage,
    domain=None,
    range=Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ],
...
slots.disease__excluded = Slot(
    uri=PHENOPACKETS.excluded,
    name="disease__excluded",
    curie=PHENOPACKETS.curie("excluded"),
    model_uri=PHENOPACKETS.disease__excluded,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.disease__laterality = Slot(
    uri=PHENOPACKETS.laterality,
    name="disease__laterality",
    curie=PHENOPACKETS.curie("laterality"),
    model_uri=PHENOPACKETS.disease__laterality,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.disease__onset = Slot(
    uri=PHENOPACKETS.onset,
    name="disease__onset",
    curie=PHENOPACKETS.curie("onset"),
    model_uri=PHENOPACKETS.disease__onset,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.disease__primarySite = Slot(
    uri=PHENOPACKETS.primarySite,
    name="disease__primarySite",
    curie=PHENOPACKETS.curie("primarySite"),
    model_uri=PHENOPACKETS.disease__primarySite,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.disease__resolution = Slot(
    uri=PHENOPACKETS.resolution,
    name="disease__resolution",
    curie=PHENOPACKETS.curie("resolution"),
    model_uri=PHENOPACKETS.disease__resolution,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.disease__term = Slot(
    uri=PHENOPACKETS.term,
    name="disease__term",
    curie=PHENOPACKETS.curie("term"),
    model_uri=PHENOPACKETS.disease__term,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.diagnosis__disease = Slot(
    uri=PHENOPACKETS.disease,
    name="diagnosis__disease",
    curie=PHENOPACKETS.curie("disease"),
    model_uri=PHENOPACKETS.diagnosis__disease,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.diagnosis__genomicInterpretations = Slot(
    uri=PHENOPACKETS.genomicInterpretations,
    name="diagnosis__genomicInterpretations",
    curie=PHENOPACKETS.curie("genomicInterpretations"),
    model_uri=PHENOPACKETS.diagnosis__genomicInterpretations,
    domain=None,
    range=Optional[Union[Union[dict, GenomicInterpretation], list[Union[dict, GenomicInterpretation]]]],
)

slots.genomicInterpretation__gene = Slot(
    uri=PHENOPACKETS.gene,
    name="genomicInterpretation__gene",
    curie=PHENOPACKETS.curie("gene"),
    model_uri=PHENOPACKETS.genomicInterpretation__gene,
    domain=None,
    range=Optional[Union[dict, GeneDescriptor]],
)

slots.genomicInterpretation__interpretationStatus = Slot(
    uri=PHENOPACKETS.interpretationStatus,
    name="genomicInterpretation__interpretationStatus",
    curie=PHENOPACKETS.curie("interpretationStatus"),
    model_uri=PHENOPACKETS.genomicInterpretation__interpretationStatus,
    domain=None,
    range=Optional[Union[str, "InterpretationStatus"]],
)

slots.genomicInterpretation__subjectOrBiosampleId = Slot(
    uri=PHENOPACKETS.subjectOrBiosampleId,
    name="genomicInterpretation__subjectOrBiosampleId",
    curie=PHENOPACKETS.curie("subjectOrBiosampleId"),
    model_uri=PHENOPACKETS.genomicInterpretation__subjectOrBiosampleId,
    domain=None,
    range=Optional[str],
)

slots.genomicInterpretation__variantInterpretation = Slot(
    uri=PHENOPACKETS.variantInterpretation,
    name="genomicInterpretation__variantInterpretation",
    curie=PHENOPACKETS.curie("variantInterpretation"),
    model_uri=PHENOPACKETS.genomicInterpretation__variantInterpretation,
    domain=None,
    range=Optional[Union[dict, VariantInterpretation]],
)

slots.interpretation__diagnosis = Slot(
    uri=PHENOPACKETS.diagnosis,
    name="interpretation__diagnosis",
    curie=PHENOPACKETS.curie("diagnosis"),
    model_uri=PHENOPACKETS.interpretation__diagnosis,
    domain=None,
    range=Optional[Union[dict, Diagnosis]],
)

slots.interpretation__id = Slot(
    uri=PHENOPACKETS.id,
    name="interpretation__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.interpretation__id,
    domain=None,
    range=Optional[str],
)

slots.interpretation__progressStatus = Slot(
    uri=PHENOPACKETS.progressStatus,
    name="interpretation__progressStatus",
    curie=PHENOPACKETS.curie("progressStatus"),
    model_uri=PHENOPACKETS.interpretation__progressStatus,
    domain=None,
    range=Optional[Union[str, "ProgressStatus"]],
)

slots.interpretation__summary = Slot(
    uri=PHENOPACKETS.summary,
    name="interpretation__summary",
    curie=PHENOPACKETS.curie("summary"),
    model_uri=PHENOPACKETS.interpretation__summary,
    domain=None,
    range=Optional[str],
)

slots.variantInterpretation__acmgPathogenicityClassification = Slot(
    uri=PHENOPACKETS.acmgPathogenicityClassification,
    name="variantInterpretation__acmgPathogenicityClassification",
    curie=PHENOPACKETS.curie("acmgPathogenicityClassification"),
    model_uri=PHENOPACKETS.variantInterpretation__acmgPathogenicityClassification,
    domain=None,
    range=Optional[Union[str, "AcmgPathogenicityClassification"]],
)

slots.variantInterpretation__therapeuticActionability = Slot(
    uri=PHENOPACKETS.therapeuticActionability,
    name="variantInterpretation__therapeuticActionability",
    curie=PHENOPACKETS.curie("therapeuticActionability"),
    model_uri=PHENOPACKETS.variantInterpretation__therapeuticActionability,
    domain=None,
    range=Optional[Union[str, "TherapeuticActionability"]],
)

slots.variantInterpretation__variationDescriptor = Slot(
    uri=PHENOPACKETS.variationDescriptor,
    name="variantInterpretation__variationDescriptor",
    curie=PHENOPACKETS.curie("variationDescriptor"),
    model_uri=PHENOPACKETS.variantInterpretation__variationDescriptor,
    domain=None,
    range=Optional[Union[dict, VariationDescriptor]],
)

slots.individual__alternateIds = Slot(
    uri=PHENOPACKETS.alternateIds,
    name="individual__alternateIds",
    curie=PHENOPACKETS.curie("alternateIds"),
    model_uri=PHENOPACKETS.individual__alternateIds,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.individual__dateOfBirth = Slot(
    uri=PHENOPACKETS.dateOfBirth,
    name="individual__dateOfBirth",
    curie=PHENOPACKETS.curie("dateOfBirth"),
    model_uri=PHENOPACKETS.individual__dateOfBirth,
    domain=None,
    range=Optional[str],
)

slots.individual__gender = Slot(
    uri=PHENOPACKETS.gender,
    name="individual__gender",
    curie=PHENOPACKETS.curie("gender"),
    model_uri=PHENOPACKETS.individual__gender,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.individual__id = Slot(
    uri=PHENOPACKETS.id,
    name="individual__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.individual__id,
    domain=None,
    range=Optional[str],
)

slots.individual__karyotypicSex = Slot(
    uri=PHENOPACKETS.karyotypicSex,
    name="individual__karyotypicSex",
    curie=PHENOPACKETS.curie("karyotypicSex"),
    model_uri=PHENOPACKETS.individual__karyotypicSex,
    domain=None,
    range=Optional[Union[str, "KaryotypicSex"]],
)

slots.individual__sex = Slot(
    uri=PHENOPACKETS.sex,
    name="individual__sex",
    curie=PHENOPACKETS.curie("sex"),
    model_uri=PHENOPACKETS.individual__sex,
    domain=None,
    range=Optional[Union[str, "Sex"]],
)

slots.individual__taxonomy = Slot(
    uri=PHENOPACKETS.taxonomy,
    name="individual__taxonomy",
    curie=PHENOPACKETS.curie("taxonomy"),
    model_uri=PHENOPACKETS.individual__taxonomy,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.individual__timeAtLastEncounter = Slot(
    uri=PHENOPACKETS.timeAtLastEncounter,
    name="individual__timeAtLastEncounter",
    curie=PHENOPACKETS.curie("timeAtLastEncounter"),
    model_uri=PHENOPACKETS.individual__timeAtLastEncounter,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.individual__vitalStatus = Slot(
    uri=PHENOPACKETS.vitalStatus,
    name="individual__vitalStatus",
    curie=PHENOPACKETS.curie("vitalStatus"),
    model_uri=PHENOPACKETS.individual__vitalStatus,
    domain=None,
    range=Optional[Union[dict, VitalStatus]],
)

slots.vitalStatus__causeOfDeath = Slot(
    uri=PHENOPACKETS.causeOfDeath,
    name="vitalStatus__causeOfDeath",
    curie=PHENOPACKETS.curie("causeOfDeath"),
    model_uri=PHENOPACKETS.vitalStatus__causeOfDeath,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.vitalStatus__status = Slot(
    uri=PHENOPACKETS.status,
    name="vitalStatus__status",
    curie=PHENOPACKETS.curie("status"),
    model_uri=PHENOPACKETS.vitalStatus__status,
    domain=None,
    range=Optional[Union[str, "Status"]],
)

slots.vitalStatus__survivalTimeInDays = Slot(
    uri=PHENOPACKETS.survivalTimeInDays,
    name="vitalStatus__survivalTimeInDays",
    curie=PHENOPACKETS.curie("survivalTimeInDays"),
    model_uri=PHENOPACKETS.vitalStatus__survivalTimeInDays,
    domain=None,
    range=Optional[int],
)

slots.vitalStatus__timeOfDeath = Slot(
    uri=PHENOPACKETS.timeOfDeath,
    name="vitalStatus__timeOfDeath",
    curie=PHENOPACKETS.curie("timeOfDeath"),
    model_uri=PHENOPACKETS.vitalStatus__timeOfDeath,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.complexValue__typedQuantities = Slot(
    uri=PHENOPACKETS.typedQuantities,
    name="complexValue__typedQuantities",
    curie=PHENOPACKETS.curie("typedQuantities"),
    model_uri=PHENOPACKETS.complexValue__typedQuantities,
    domain=None,
    range=Optional[Union[Union[dict, TypedQuantity], list[Union[dict, TypedQuantity]]]],
)

slots.measurement__assay = Slot(
    uri=PHENOPACKETS.assay,
    name="measurement__assay",
    curie=PHENOPACKETS.curie("assay"),
    model_uri=PHENOPACKETS.measurement__assay,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.measurement__complexValue = Slot(
    uri=PHENOPACKETS.complexValue,
    name="measurement__complexValue",
    curie=PHENOPACKETS.curie("complexValue"),
    model_uri=PHENOPACKETS.measurement__complexValue,
    domain=None,
    range=Optional[Union[dict, ComplexValue]],
)

slots.measurement__description = Slot(
    uri=PHENOPACKETS.description,
    name="measurement__description",
    curie=PHENOPACKETS.curie("description"),
    model_uri=PHENOPACKETS.measurement__description,
    domain=None,
    range=Optional[str],
)

slots.measurement__procedure = Slot(
    uri=PHENOPACKETS.procedure,
    name="measurement__procedure",
    curie=PHENOPACKETS.curie("procedure"),
    model_uri=PHENOPACKETS.measurement__procedure,
    domain=None,
    range=Optional[Union[dict, Procedure]],
)

slots.measurement__timeObserved = Slot(
    uri=PHENOPACKETS.timeObserved,
    name="measurement__timeObserved",
    curie=PHENOPACKETS.curie("timeObserved"),
    model_uri=PHENOPACKETS.measurement__timeObserved,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.measurement__value = Slot(
    uri=PHENOPACKETS.value,
    name="measurement__value",
    curie=PHENOPACKETS.curie("value"),
    model_uri=PHENOPACKETS.measurement__value,
    domain=None,
    range=Optional[Union[dict, Value]],
)

slots.quantity__referenceRange = Slot(
    uri=PHENOPACKETS.referenceRange,
    name="quantity__referenceRange",
    curie=PHENOPACKETS.curie("referenceRange"),
    model_uri=PHENOPACKETS.quantity__referenceRange,
    domain=None,
    range=Optional[Union[dict, ReferenceRange]],
)

slots.quantity__unit = Slot(
    uri=PHENOPACKETS.unit,
    name="quantity__unit",
    curie=PHENOPACKETS.curie("unit"),
    model_uri=PHENOPACKETS.quantity__unit,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.quantity__value = Slot(
    uri=PHENOPACKETS.value,
    name="quantity__value",
    curie=PHENOPACKETS.curie("value"),
    model_uri=PHENOPACKETS.quantity__value,
    domain=None,
    range=Optional[float],
)

slots.referenceRange__high = Slot(
    uri=PHENOPACKETS.high,
    name="referenceRange__high",
    curie=PHENOPACKETS.curie("high"),
    model_uri=PHENOPACKETS.referenceRange__high,
    domain=None,
    range=Optional[float],
)

slots.referenceRange__low = Slot(
    uri=PHENOPACKETS.low,
    name="referenceRange__low",
    curie=PHENOPACKETS.curie("low"),
    model_uri=PHENOPACKETS.referenceRange__low,
    domain=None,
    range=Optional[float],
)

slots.referenceRange__unit = Slot(
    uri=PHENOPACKETS.unit,
    name="referenceRange__unit",
    curie=PHENOPACKETS.curie("unit"),
    model_uri=PHENOPACKETS.referenceRange__unit,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.typedQuantity__quantity = Slot(
    uri=PHENOPACKETS.quantity,
    name="typedQuantity__quantity",
    curie=PHENOPACKETS.curie("quantity"),
    model_uri=PHENOPACKETS.typedQuantity__quantity,
    domain=None,
    range=Optional[Union[dict, Quantity]],
)

slots.typedQuantity__type = Slot(
    uri=PHENOPACKETS.type,
    name="typedQuantity__type",
    curie=PHENOPACKETS.curie("type"),
    model_uri=PHENOPACKETS.typedQuantity__type,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.value__ontologyClass = Slot(
    uri=PHENOPACKETS.ontologyClass,
    name="value__ontologyClass",
    curie=PHENOPACKETS.curie("ontologyClass"),
    model_uri=PHENOPACKETS.value__ontologyClass,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.value__quantity = Slot(
    uri=PHENOPACKETS.quantity,
    name="value__quantity",
    curie=PHENOPACKETS.curie("quantity"),
    model_uri=PHENOPACKETS.value__quantity,
    domain=None,
    range=Optional[Union[dict, Quantity]],
)

slots.doseInterval__interval = Slot(
    uri=PHENOPACKETS.interval,
    name="doseInterval__interval",
    curie=PHENOPACKETS.curie("interval"),
    model_uri=PHENOPACKETS.doseInterval__interval,
    domain=None,
    range=Optional[Union[dict, TimeInterval]],
)

slots.doseInterval__quantity = Slot(
    uri=PHENOPACKETS.quantity,
    name="doseInterval__quantity",
    curie=PHENOPACKETS.curie("quantity"),
    model_uri=PHENOPACKETS.doseInterval__quantity,
    domain=None,
    range=Optional[Union[dict, Quantity]],
)

slots.doseInterval__scheduleFrequency = Slot(
    uri=PHENOPACKETS.scheduleFrequency,
    name="doseInterval__scheduleFrequency",
    curie=PHENOPACKETS.curie("scheduleFrequency"),
    model_uri=PHENOPACKETS.doseInterval__scheduleFrequency,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.medicalAction__adverseEvents = Slot(
    uri=PHENOPACKETS.adverseEvents,
    name="medicalAction__adverseEvents",
    curie=PHENOPACKETS.curie("adverseEvents"),
    model_uri=PHENOPACKETS.medicalAction__adverseEvents,
    domain=None,
    range=Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ],
...
slots.medicalAction__procedure = Slot(
    uri=PHENOPACKETS.procedure,
    name="medicalAction__procedure",
    curie=PHENOPACKETS.curie("procedure"),
    model_uri=PHENOPACKETS.medicalAction__procedure,
    domain=None,
    range=Optional[Union[dict, Procedure]],
)

slots.medicalAction__radiationTherapy = Slot(
    uri=PHENOPACKETS.radiationTherapy,
    name="medicalAction__radiationTherapy",
    curie=PHENOPACKETS.curie("radiationTherapy"),
    model_uri=PHENOPACKETS.medicalAction__radiationTherapy,
    domain=None,
    range=Optional[Union[dict, RadiationTherapy]],
)

slots.medicalAction__responseToTreatment = Slot(
    uri=PHENOPACKETS.responseToTreatment,
    name="medicalAction__responseToTreatment",
    curie=PHENOPACKETS.curie("responseToTreatment"),
    model_uri=PHENOPACKETS.medicalAction__responseToTreatment,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.medicalAction__therapeuticRegimen = Slot(
    uri=PHENOPACKETS.therapeuticRegimen,
    name="medicalAction__therapeuticRegimen",
    curie=PHENOPACKETS.curie("therapeuticRegimen"),
    model_uri=PHENOPACKETS.medicalAction__therapeuticRegimen,
    domain=None,
    range=Optional[Union[dict, TherapeuticRegimen]],
)

slots.medicalAction__treatment = Slot(
    uri=PHENOPACKETS.treatment,
    name="medicalAction__treatment",
    curie=PHENOPACKETS.curie("treatment"),
    model_uri=PHENOPACKETS.medicalAction__treatment,
    domain=None,
    range=Optional[Union[dict, Treatment]],
)

slots.medicalAction__treatmentIntent = Slot(
    uri=PHENOPACKETS.treatmentIntent,
    name="medicalAction__treatmentIntent",
    curie=PHENOPACKETS.curie("treatmentIntent"),
    model_uri=PHENOPACKETS.medicalAction__treatmentIntent,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.medicalAction__treatmentTarget = Slot(
    uri=PHENOPACKETS.treatmentTarget,
    name="medicalAction__treatmentTarget",
    curie=PHENOPACKETS.curie("treatmentTarget"),
    model_uri=PHENOPACKETS.medicalAction__treatmentTarget,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.medicalAction__treatmentTerminationReason = Slot(
    uri=PHENOPACKETS.treatmentTerminationReason,
    name="medicalAction__treatmentTerminationReason",
    curie=PHENOPACKETS.curie("treatmentTerminationReason"),
    model_uri=PHENOPACKETS.medicalAction__treatmentTerminationReason,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.radiationTherapy__bodySite = Slot(
    uri=PHENOPACKETS.bodySite,
    name="radiationTherapy__bodySite",
    curie=PHENOPACKETS.curie("bodySite"),
    model_uri=PHENOPACKETS.radiationTherapy__bodySite,
    domain=None,
    range=Union[dict, OntologyClass],
)

slots.radiationTherapy__dosage = Slot(
    uri=PHENOPACKETS.dosage,
    name="radiationTherapy__dosage",
    curie=PHENOPACKETS.curie("dosage"),
    model_uri=PHENOPACKETS.radiationTherapy__dosage,
    domain=None,
    range=int,
)

slots.radiationTherapy__fractions = Slot(
    uri=PHENOPACKETS.fractions,
    name="radiationTherapy__fractions",
    curie=PHENOPACKETS.curie("fractions"),
    model_uri=PHENOPACKETS.radiationTherapy__fractions,
    domain=None,
    range=int,
)

slots.radiationTherapy__modality = Slot(
    uri=PHENOPACKETS.modality,
    name="radiationTherapy__modality",
    curie=PHENOPACKETS.curie("modality"),
    model_uri=PHENOPACKETS.radiationTherapy__modality,
    domain=None,
    range=Union[dict, OntologyClass],
)

slots.therapeuticRegimen__endTime = Slot(
    uri=PHENOPACKETS.endTime,
    name="therapeuticRegimen__endTime",
    curie=PHENOPACKETS.curie("endTime"),
    model_uri=PHENOPACKETS.therapeuticRegimen__endTime,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.therapeuticRegimen__externalReference = Slot(
    uri=PHENOPACKETS.externalReference,
    name="therapeuticRegimen__externalReference",
    curie=PHENOPACKETS.curie("externalReference"),
    model_uri=PHENOPACKETS.therapeuticRegimen__externalReference,
    domain=None,
    range=Optional[Union[dict, ExternalReference]],
)

slots.therapeuticRegimen__ontologyClass = Slot(
    uri=PHENOPACKETS.ontologyClass,
    name="therapeuticRegimen__ontologyClass",
    curie=PHENOPACKETS.curie("ontologyClass"),
    model_uri=PHENOPACKETS.therapeuticRegimen__ontologyClass,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.therapeuticRegimen__regimenStatus = Slot(
    uri=PHENOPACKETS.regimenStatus,
    name="therapeuticRegimen__regimenStatus",
    curie=PHENOPACKETS.curie("regimenStatus"),
    model_uri=PHENOPACKETS.therapeuticRegimen__regimenStatus,
    domain=None,
    range=Optional[Union[str, "RegimenStatus"]],
)

slots.therapeuticRegimen__startTime = Slot(
    uri=PHENOPACKETS.startTime,
    name="therapeuticRegimen__startTime",
    curie=PHENOPACKETS.curie("startTime"),
    model_uri=PHENOPACKETS.therapeuticRegimen__startTime,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.treatment__agent = Slot(
    uri=PHENOPACKETS.agent,
    name="treatment__agent",
    curie=PHENOPACKETS.curie("agent"),
    model_uri=PHENOPACKETS.treatment__agent,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.treatment__cumulativeDose = Slot(
    uri=PHENOPACKETS.cumulativeDose,
    name="treatment__cumulativeDose",
    curie=PHENOPACKETS.curie("cumulativeDose"),
    model_uri=PHENOPACKETS.treatment__cumulativeDose,
    domain=None,
    range=Optional[Union[dict, Quantity]],
)

slots.treatment__doseIntervals = Slot(
    uri=PHENOPACKETS.doseIntervals,
    name="treatment__doseIntervals",
    curie=PHENOPACKETS.curie("doseIntervals"),
    model_uri=PHENOPACKETS.treatment__doseIntervals,
    domain=None,
    range=Optional[Union[Union[dict, DoseInterval], list[Union[dict, DoseInterval]]]],
)

slots.treatment__drugType = Slot(
    uri=PHENOPACKETS.drugType,
    name="treatment__drugType",
    curie=PHENOPACKETS.curie("drugType"),
    model_uri=PHENOPACKETS.treatment__drugType,
    domain=None,
    range=Optional[Union[str, "DrugType"]],
)

slots.treatment__routeOfAdministration = Slot(
    uri=PHENOPACKETS.routeOfAdministration,
    name="treatment__routeOfAdministration",
    curie=PHENOPACKETS.curie("routeOfAdministration"),
    model_uri=PHENOPACKETS.treatment__routeOfAdministration,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.metaData__created = Slot(
    uri=PHENOPACKETS.created,
    name="metaData__created",
    curie=PHENOPACKETS.curie("created"),
    model_uri=PHENOPACKETS.metaData__created,
    domain=None,
    range=Optional[str],
)

slots.metaData__createdBy = Slot(
    uri=PHENOPACKETS.createdBy,
    name="metaData__createdBy",
    curie=PHENOPACKETS.curie("createdBy"),
    model_uri=PHENOPACKETS.metaData__createdBy,
    domain=None,
    range=Optional[str],
)

slots.metaData__externalReferences = Slot(
    uri=PHENOPACKETS.externalReferences,
    name="metaData__externalReferences",
    curie=PHENOPACKETS.curie("externalReferences"),
    model_uri=PHENOPACKETS.metaData__externalReferences,
    domain=None,
    range=Optional[Union[Union[dict, ExternalReference], list[Union[dict, ExternalReference]]]],
)

slots.metaData__phenopacketSchemaVersion = Slot(
    uri=PHENOPACKETS.phenopacketSchemaVersion,
    name="metaData__phenopacketSchemaVersion",
    curie=PHENOPACKETS.curie("phenopacketSchemaVersion"),
    model_uri=PHENOPACKETS.metaData__phenopacketSchemaVersion,
    domain=None,
    range=Optional[str],
)

slots.metaData__resources = Slot(
    uri=PHENOPACKETS.resources,
    name="metaData__resources",
    curie=PHENOPACKETS.curie("resources"),
    model_uri=PHENOPACKETS.metaData__resources,
    domain=None,
    range=Optional[Union[Union[dict, Resource], list[Union[dict, Resource]]]],
)

slots.metaData__submittedBy = Slot(
    uri=PHENOPACKETS.submittedBy,
    name="metaData__submittedBy",
    curie=PHENOPACKETS.curie("submittedBy"),
    model_uri=PHENOPACKETS.metaData__submittedBy,
    domain=None,
    range=Optional[str],
)

slots.metaData__updates = Slot(
    uri=PHENOPACKETS.updates,
    name="metaData__updates",
    curie=PHENOPACKETS.curie("updates"),
    model_uri=PHENOPACKETS.metaData__updates,
    domain=None,
    range=Optional[Union[Union[dict, Update], list[Union[dict, Update]]]],
)
...
slots.resource__id = Slot(
    ...
    name="resource__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.resource__id,
    domain=None,
    range=Optional[str],
)

slots.resource__iriPrefix = Slot(
    uri=PHENOPACKETS.iriPrefix,
    name="resource__iriPrefix",
    curie=PHENOPACKETS.curie("iriPrefix"),
    model_uri=PHENOPACKETS.resource__iriPrefix,
    domain=None,
    range=Optional[str],
)

slots.resource__name = Slot(
    uri=PHENOPACKETS.name,
    name="resource__name",
    curie=PHENOPACKETS.curie("name"),
    model_uri=PHENOPACKETS.resource__name,
    domain=None,
    range=Optional[str],
)

slots.resource__namespacePrefix = Slot(
    uri=PHENOPACKETS.namespacePrefix,
    name="resource__namespacePrefix",
    curie=PHENOPACKETS.curie("namespacePrefix"),
    model_uri=PHENOPACKETS.resource__namespacePrefix,
    domain=None,
    range=Optional[str],
)

slots.resource__url = Slot(
    uri=PHENOPACKETS.url,
    name="resource__url",
    curie=PHENOPACKETS.curie("url"),
    model_uri=PHENOPACKETS.resource__url,
    domain=None,
    range=Optional[str],
)

slots.resource__version = Slot(
    uri=PHENOPACKETS.version,
    name="resource__version",
    curie=PHENOPACKETS.curie("version"),
    model_uri=PHENOPACKETS.resource__version,
    domain=None,
    range=Optional[str],
)

slots.update__comment = Slot(
    uri=PHENOPACKETS.comment,
    name="update__comment",
    curie=PHENOPACKETS.curie("comment"),
    model_uri=PHENOPACKETS.update__comment,
    domain=None,
    range=Optional[str],
)

slots.update__timestamp = Slot(
    uri=PHENOPACKETS.timestamp,
    name="update__timestamp",
    curie=PHENOPACKETS.curie("timestamp"),
    model_uri=PHENOPACKETS.update__timestamp,
    domain=None,
    range=str,
)

slots.update__updatedBy = Slot(
    uri=PHENOPACKETS.updatedBy,
    name="update__updatedBy",
    curie=PHENOPACKETS.curie("updatedBy"),
    model_uri=PHENOPACKETS.update__updatedBy,
    domain=None,
    range=Optional[str],
)

slots.pedigree__persons = Slot(
    uri=PHENOPACKETS.persons,
    name="pedigree__persons",
    curie=PHENOPACKETS.curie("persons"),
    model_uri=PHENOPACKETS.pedigree__persons,
    domain=None,
    range=Optional[Union[Union[dict, Person], list[Union[dict, Person]]]],
)

slots.person__affectedStatus = Slot(
    uri=PHENOPACKETS.affectedStatus,
    name="person__affectedStatus",
    curie=PHENOPACKETS.curie("affectedStatus"),
    model_uri=PHENOPACKETS.person__affectedStatus,
    domain=None,
    range=Optional[Union[str, "AffectedStatus"]],
)

slots.person__familyId = Slot(
    uri=PHENOPACKETS.familyId,
    name="person__familyId",
    curie=PHENOPACKETS.curie("familyId"),
    model_uri=PHENOPACKETS.person__familyId,
    domain=None,
    range=Optional[str],
)

slots.person__individualId = Slot(
    uri=PHENOPACKETS.individualId,
    name="person__individualId",
    curie=PHENOPACKETS.curie("individualId"),
    model_uri=PHENOPACKETS.person__individualId,
    domain=None,
    range=Optional[str],
)

slots.person__maternalId = Slot(
    uri=PHENOPACKETS.maternalId,
    name="person__maternalId",
    curie=PHENOPACKETS.curie("maternalId"),
    model_uri=PHENOPACKETS.person__maternalId,
    domain=None,
    range=Optional[str],
)

slots.person__paternalId = Slot(
    uri=PHENOPACKETS.paternalId,
    name="person__paternalId",
    curie=PHENOPACKETS.curie("paternalId"),
    model_uri=PHENOPACKETS.person__paternalId,
    domain=None,
    range=Optional[str],
)

slots.person__sex = Slot(
    uri=PHENOPACKETS.sex,
    name="person__sex",
    curie=PHENOPACKETS.curie("sex"),
    model_uri=PHENOPACKETS.person__sex,
    domain=None,
    range=Optional[Union[str, "Sex"]],
)

slots.phenotypicFeature__description = Slot(
    uri=PHENOPACKETS.description,
    name="phenotypicFeature__description",
    curie=PHENOPACKETS.curie("description"),
    model_uri=PHENOPACKETS.phenotypicFeature__description,
    domain=None,
    range=Optional[str],
)

slots.phenotypicFeature__evidence = Slot(
    uri=PHENOPACKETS.evidence,
    name="phenotypicFeature__evidence",
    curie=PHENOPACKETS.curie("evidence"),
    model_uri=PHENOPACKETS.phenotypicFeature__evidence,
    domain=None,
    range=Optional[Union[Union[dict, Evidence], list[Union[dict, Evidence]]]],
)

slots.phenotypicFeature__excluded = Slot(
    uri=PHENOPACKETS.excluded,
    name="phenotypicFeature__excluded",
    curie=PHENOPACKETS.curie("excluded"),
    model_uri=PHENOPACKETS.phenotypicFeature__excluded,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.phenotypicFeature__modifiers = Slot(
    uri=PHENOPACKETS.modifiers,
    name="phenotypicFeature__modifiers",
    curie=PHENOPACKETS.curie("modifiers"),
    model_uri=PHENOPACKETS.phenotypicFeature__modifiers,
    domain=None,
    range=Optional[
        Union[dict[Union[str, OntologyClassId], Union[dict, OntologyClass]], list[Union[dict, OntologyClass]]]
    ],
...
slots.phenotypicFeature__onset = Slot(
    uri=PHENOPACKETS.onset,
    name="phenotypicFeature__onset",
    curie=PHENOPACKETS.curie("onset"),
    model_uri=PHENOPACKETS.phenotypicFeature__onset,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.phenotypicFeature__resolution = Slot(
    uri=PHENOPACKETS.resolution,
    name="phenotypicFeature__resolution",
    curie=PHENOPACKETS.curie("resolution"),
    model_uri=PHENOPACKETS.phenotypicFeature__resolution,
    domain=None,
    range=Optional[Union[dict, TimeElement]],
)

slots.phenotypicFeature__severity = Slot(
    uri=PHENOPACKETS.severity,
    name="phenotypicFeature__severity",
    curie=PHENOPACKETS.curie("severity"),
    model_uri=PHENOPACKETS.phenotypicFeature__severity,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.phenotypicFeature__type = Slot(
    uri=PHENOPACKETS.type,
    name="phenotypicFeature__type",
    curie=PHENOPACKETS.curie("type"),
    model_uri=PHENOPACKETS.phenotypicFeature__type,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.timestamp__nanos = Slot(
    uri=PHENOPACKETS.nanos,
    name="timestamp__nanos",
    curie=PHENOPACKETS.curie("nanos"),
    model_uri=PHENOPACKETS.timestamp__nanos,
    domain=None,
    range=Optional[int],
)

slots.timestamp__seconds = Slot(
    uri=PHENOPACKETS.seconds,
    name="timestamp__seconds",
    curie=PHENOPACKETS.curie("seconds"),
    model_uri=PHENOPACKETS.timestamp__seconds,
    domain=None,
    range=Optional[int],
)

slots.expression__syntax = Slot(
    uri=PHENOPACKETS.syntax,
    name="expression__syntax",
    curie=PHENOPACKETS.curie("syntax"),
    model_uri=PHENOPACKETS.expression__syntax,
    domain=None,
    range=Optional[str],
)

slots.expression__value = Slot(
    uri=PHENOPACKETS.value,
    name="expression__value",
    curie=PHENOPACKETS.curie("value"),
    model_uri=PHENOPACKETS.expression__value,
    domain=None,
    range=Optional[str],
)

slots.expression__version = Slot(
    uri=PHENOPACKETS.version,
    name="expression__version",
    curie=PHENOPACKETS.curie("version"),
    model_uri=PHENOPACKETS.expression__version,
    domain=None,
    range=Optional[str],
)

slots.extension__name = Slot(
    uri=PHENOPACKETS.name,
    name="extension__name",
    curie=PHENOPACKETS.curie("name"),
    model_uri=PHENOPACKETS.extension__name,
    domain=None,
    range=Optional[str],
)

slots.extension__value = Slot(
    uri=PHENOPACKETS.value,
    name="extension__value",
    curie=PHENOPACKETS.curie("value"),
    model_uri=PHENOPACKETS.extension__value,
    domain=None,
    range=Optional[Union[Union[dict, Any], list[Union[dict, Any]]]],
)

slots.geneDescriptor__alternateIds = Slot(
    uri=PHENOPACKETS.alternateIds,
    name="geneDescriptor__alternateIds",
    curie=PHENOPACKETS.curie("alternateIds"),
    model_uri=PHENOPACKETS.geneDescriptor__alternateIds,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.geneDescriptor__alternateSymbols = Slot(
    uri=PHENOPACKETS.alternateSymbols,
    name="geneDescriptor__alternateSymbols",
    curie=PHENOPACKETS.curie("alternateSymbols"),
    model_uri=PHENOPACKETS.geneDescriptor__alternateSymbols,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.geneDescriptor__description = Slot(
    uri=PHENOPACKETS.description,
    name="geneDescriptor__description",
    curie=PHENOPACKETS.curie("description"),
    model_uri=PHENOPACKETS.geneDescriptor__description,
    domain=None,
    range=Optional[str],
)

slots.geneDescriptor__symbol = Slot(
    uri=PHENOPACKETS.symbol,
    name="geneDescriptor__symbol",
    curie=PHENOPACKETS.curie("symbol"),
    model_uri=PHENOPACKETS.geneDescriptor__symbol,
    domain=None,
    range=Optional[str],
)

slots.geneDescriptor__valueId = Slot(
    uri=PHENOPACKETS.valueId,
    name="geneDescriptor__valueId",
    curie=PHENOPACKETS.curie("valueId"),
    model_uri=PHENOPACKETS.geneDescriptor__valueId,
    domain=None,
    range=Optional[str],
)

slots.geneDescriptor__xrefs = Slot(
    uri=PHENOPACKETS.xrefs,
    name="geneDescriptor__xrefs",
    curie=PHENOPACKETS.curie("xrefs"),
    model_uri=PHENOPACKETS.geneDescriptor__xrefs,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.variationDescriptor__allelicState = Slot(
    uri=PHENOPACKETS.allelicState,
    name="variationDescriptor__allelicState",
    curie=PHENOPACKETS.curie("allelicState"),
    model_uri=PHENOPACKETS.variationDescriptor__allelicState,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.variationDescriptor__alternateLabels = Slot(
    uri=PHENOPACKETS.alternateLabels,
    name="variationDescriptor__alternateLabels",
    curie=PHENOPACKETS.curie("alternateLabels"),
    model_uri=PHENOPACKETS.variationDescriptor__alternateLabels,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.variationDescriptor__description = Slot(
    uri=PHENOPACKETS.description,
    name="variationDescriptor__description",
    curie=PHENOPACKETS.curie("description"),
    model_uri=PHENOPACKETS.variationDescriptor__description,
    domain=None,
    range=Optional[str],
)

slots.variationDescriptor__expressions = Slot(
    uri=PHENOPACKETS.expressions,
    name="variationDescriptor__expressions",
    curie=PHENOPACKETS.curie("expressions"),
    model_uri=PHENOPACKETS.variationDescriptor__expressions,
    domain=None,
    range=Optional[Union[Union[dict, Expression], list[Union[dict, Expression]]]],
)

slots.variationDescriptor__extensions = Slot(
    uri=PHENOPACKETS.extensions,
    name="variationDescriptor__extensions",
    curie=PHENOPACKETS.curie("extensions"),
    model_uri=PHENOPACKETS.variationDescriptor__extensions,
    domain=None,
    range=Optional[Union[Union[dict, Extension], list[Union[dict, Extension]]]],
)

slots.variationDescriptor__geneContext = Slot(
    uri=PHENOPACKETS.geneContext,
    name="variationDescriptor__geneContext",
    curie=PHENOPACKETS.curie("geneContext"),
    model_uri=PHENOPACKETS.variationDescriptor__geneContext,
    domain=None,
    range=Optional[Union[dict, GeneDescriptor]],
)

slots.variationDescriptor__id = Slot(
    uri=PHENOPACKETS.id,
    name="variationDescriptor__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.variationDescriptor__id,
    domain=None,
    range=Optional[str],
)

slots.variationDescriptor__label = Slot(
    uri=PHENOPACKETS.label,
    name="variationDescriptor__label",
    curie=PHENOPACKETS.curie("label"),
    model_uri=PHENOPACKETS.variationDescriptor__label,
    domain=None,
    range=Optional[str],
)

slots.variationDescriptor__moleculeContext = Slot(
    uri=PHENOPACKETS.moleculeContext,
    name="variationDescriptor__moleculeContext",
    curie=PHENOPACKETS.curie("moleculeContext"),
    model_uri=PHENOPACKETS.variationDescriptor__moleculeContext,
    domain=None,
    range=Optional[Union[str, "MoleculeContext"]],
)

slots.variationDescriptor__structuralType = Slot(
    uri=PHENOPACKETS.structuralType,
    name="variationDescriptor__structuralType",
    curie=PHENOPACKETS.curie("structuralType"),
    model_uri=PHENOPACKETS.variationDescriptor__structuralType,
    domain=None,
    range=Optional[Union[dict, OntologyClass]],
)

slots.variationDescriptor__variation = Slot(
    uri=PHENOPACKETS.variation,
    name="variationDescriptor__variation",
    curie=PHENOPACKETS.curie("variation"),
    model_uri=PHENOPACKETS.variationDescriptor__variation,
    domain=None,
    range=Optional[Union[dict, Variation]],
)

slots.variationDescriptor__vcfRecord = Slot(
    uri=PHENOPACKETS.vcfRecord,
    name="variationDescriptor__vcfRecord",
    curie=PHENOPACKETS.curie("vcfRecord"),
    model_uri=PHENOPACKETS.variationDescriptor__vcfRecord,
    domain=None,
    range=Optional[Union[dict, VcfRecord]],
)

slots.variationDescriptor__vrsRefAlleleSeq = Slot(
    uri=PHENOPACKETS.vrsRefAlleleSeq,
    name="variationDescriptor__vrsRefAlleleSeq",
    curie=PHENOPACKETS.curie("vrsRefAlleleSeq"),
    model_uri=PHENOPACKETS.variationDescriptor__vrsRefAlleleSeq,
    domain=None,
    range=Optional[str],
)

slots.variationDescriptor__xrefs = Slot(
    uri=PHENOPACKETS.xrefs,
    name="variationDescriptor__xrefs",
    curie=PHENOPACKETS.curie("xrefs"),
    model_uri=PHENOPACKETS.variationDescriptor__xrefs,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.vcfRecord__alt = Slot(
    uri=PHENOPACKETS.alt,
    name="vcfRecord__alt",
    curie=PHENOPACKETS.curie("alt"),
    model_uri=PHENOPACKETS.vcfRecord__alt,
    domain=None,
    range=Optional[str],
)

slots.vcfRecord__chrom = Slot(
    uri=PHENOPACKETS.chrom,
    name="vcfRecord__chrom",
    curie=PHENOPACKETS.curie("chrom"),
    model_uri=PHENOPACKETS.vcfRecord__chrom,
    domain=None,
    range=Optional[str],
)

slots.vcfRecord__filter = Slot(
    uri=PHENOPACKETS.filter,
    name="vcfRecord__filter",
    curie=PHENOPACKETS.curie("filter"),
    model_uri=PHENOPACKETS.vcfRecord__filter,
    domain=None,
    range=Optional[str],
)

slots.vcfRecord__genomeAssembly = Slot(
    uri=PHENOPACKETS.genomeAssembly,
    name="vcfRecord__genomeAssembly",
    curie=PHENOPACKETS.curie("genomeAssembly"),
    model_uri=PHENOPACKETS.vcfRecord__genomeAssembly,
    domain=None,
    range=Optional[str],
)

slots.vcfRecord__id = Slot(
    uri=PHENOPACKETS.id,
    name="vcfRecord__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.vcfRecord__id,
    domain=None,
    range=Optional[str],
)

slots.vcfRecord__info = Slot(
    uri=PHENOPACKETS.info,
    name="vcfRecord__info",
    curie=PHENOPACKETS.curie("info"),
    model_uri=PHENOPACKETS.vcfRecord__info,
    domain=None,
    range=Optional[str],
)

slots.vcfRecord__pos = Slot(
    uri=PHENOPACKETS.pos,
    name="vcfRecord__pos",
    curie=PHENOPACKETS.curie("pos"),
    model_uri=PHENOPACKETS.vcfRecord__pos,
    domain=None,
    range=Optional[int],
)

slots.vcfRecord__qual = Slot(
    uri=PHENOPACKETS.qual,
    name="vcfRecord__qual",
    curie=PHENOPACKETS.curie("qual"),
    model_uri=PHENOPACKETS.vcfRecord__qual,
    domain=None,
    range=Optional[str],
)

slots.vcfRecord__ref = Slot(
    uri=PHENOPACKETS.ref,
    name="vcfRecord__ref",
    curie=PHENOPACKETS.curie("ref"),
    model_uri=PHENOPACKETS.vcfRecord__ref,
    domain=None,
    range=Optional[str],
)

slots.any__typeUrl = Slot(
    uri=PHENOPACKETS.typeUrl,
    name="any__typeUrl",
    curie=PHENOPACKETS.curie("typeUrl"),
    model_uri=PHENOPACKETS.any__typeUrl,
    domain=None,
    range=Optional[str],
)

slots.any__value = Slot(
    uri=PHENOPACKETS.value,
    name="any__value",
    curie=PHENOPACKETS.curie("value"),
    model_uri=PHENOPACKETS.any__value,
    domain=None,
    range=Optional[str],
)

slots.abundance__copyNumber = Slot(
    uri=PHENOPACKETS.copyNumber,
    name="abundance__copyNumber",
    curie=PHENOPACKETS.curie("copyNumber"),
    model_uri=PHENOPACKETS.abundance__copyNumber,
    domain=None,
    range=Optional[Union[dict, CopyNumber]],
)

slots.allele__chromosomeLocation = Slot(
    uri=PHENOPACKETS.chromosomeLocation,
    name="allele__chromosomeLocation",
    curie=PHENOPACKETS.curie("chromosomeLocation"),
    model_uri=PHENOPACKETS.allele__chromosomeLocation,
    domain=None,
    range=Optional[Union[dict, ChromosomeLocation]],
)

slots.allele__curie = Slot(
    uri=PHENOPACKETS.curie,
    name="allele__curie",
    curie=PHENOPACKETS.curie("curie"),
    model_uri=PHENOPACKETS.allele__curie,
    domain=None,
    range=Optional[str],
)

slots.allele__derivedSequenceExpression = Slot(
    uri=PHENOPACKETS.derivedSequenceExpression,
    name="allele__derivedSequenceExpression",
    curie=PHENOPACKETS.curie("derivedSequenceExpression"),
    model_uri=PHENOPACKETS.allele__derivedSequenceExpression,
    domain=None,
    range=Optional[Union[dict, DerivedSequenceExpression]],
)

slots.allele__id = Slot(
    uri=PHENOPACKETS.id,
    name="allele__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.allele__id,
    domain=None,
    range=Optional[str],
)

slots.allele__literalSequenceExpression = Slot(
    uri=PHENOPACKETS.literalSequenceExpression,
    name="allele__literalSequenceExpression",
    curie=PHENOPACKETS.curie("literalSequenceExpression"),
    model_uri=PHENOPACKETS.allele__literalSequenceExpression,
    domain=None,
    range=Optional[Union[dict, LiteralSequenceExpression]],
)

slots.allele__repeatedSequenceExpression = Slot(
    uri=PHENOPACKETS.repeatedSequenceExpression,
    name="allele__repeatedSequenceExpression",
    curie=PHENOPACKETS.curie("repeatedSequenceExpression"),
    model_uri=PHENOPACKETS.allele__repeatedSequenceExpression,
    domain=None,
    range=Optional[Union[dict, RepeatedSequenceExpression]],
)

slots.allele__sequenceLocation = Slot(
    uri=PHENOPACKETS.sequenceLocation,
    name="allele__sequenceLocation",
    curie=PHENOPACKETS.curie("sequenceLocation"),
    model_uri=PHENOPACKETS.allele__sequenceLocation,
    domain=None,
    range=Optional[Union[dict, SequenceLocation]],
)

slots.chromosomeLocation__chr = Slot(
    uri=PHENOPACKETS.chr,
    name="chromosomeLocation__chr",
    curie=PHENOPACKETS.curie("chr"),
    model_uri=PHENOPACKETS.chromosomeLocation__chr,
    domain=None,
    range=Optional[str],
)

slots.chromosomeLocation__id = Slot(
    uri=PHENOPACKETS.id,
    name="chromosomeLocation__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.chromosomeLocation__id,
    domain=None,
    range=Optional[str],
)

slots.chromosomeLocation__interval = Slot(
    uri=PHENOPACKETS.interval,
    name="chromosomeLocation__interval",
    curie=PHENOPACKETS.curie("interval"),
    model_uri=PHENOPACKETS.chromosomeLocation__interval,
    domain=None,
    range=Optional[Union[dict, CytobandInterval]],
)

slots.chromosomeLocation__speciesId = Slot(
    uri=PHENOPACKETS.speciesId,
    name="chromosomeLocation__speciesId",
    curie=PHENOPACKETS.curie("speciesId"),
    model_uri=PHENOPACKETS.chromosomeLocation__speciesId,
    domain=None,
    range=Optional[str],
)

slots.copyNumber__allele = Slot(
    uri=PHENOPACKETS.allele,
    name="copyNumber__allele",
    curie=PHENOPACKETS.curie("allele"),
    model_uri=PHENOPACKETS.copyNumber__allele,
    domain=None,
    range=Optional[Union[dict, Allele]],
)

slots.copyNumber__curie = Slot(
    uri=PHENOPACKETS.curie,
    name="copyNumber__curie",
    curie=PHENOPACKETS.curie("curie"),
    model_uri=PHENOPACKETS.copyNumber__curie,
    domain=None,
    range=Optional[str],
)

slots.copyNumber__definiteRange = Slot(
    uri=PHENOPACKETS.definiteRange,
    name="copyNumber__definiteRange",
    curie=PHENOPACKETS.curie("definiteRange"),
    model_uri=PHENOPACKETS.copyNumber__definiteRange,
    domain=None,
    range=Optional[Union[dict, DefiniteRange]],
)

slots.copyNumber__derivedSequenceExpression = Slot(
    uri=PHENOPACKETS.derivedSequenceExpression,
    name="copyNumber__derivedSequenceExpression",
    curie=PHENOPACKETS.curie("derivedSequenceExpression"),
    model_uri=PHENOPACKETS.copyNumber__derivedSequenceExpression,
    domain=None,
    range=Optional[Union[dict, DerivedSequenceExpression]],
)

slots.copyNumber__gene = Slot(
    uri=PHENOPACKETS.gene,
    name="copyNumber__gene",
    curie=PHENOPACKETS.curie("gene"),
    model_uri=PHENOPACKETS.copyNumber__gene,
    domain=None,
    range=Optional[Union[dict, Gene]],
)

slots.copyNumber__haplotype = Slot(
    uri=PHENOPACKETS.haplotype,
    name="copyNumber__haplotype",
    curie=PHENOPACKETS.curie("haplotype"),
    model_uri=PHENOPACKETS.copyNumber__haplotype,
    domain=None,
    range=Optional[Union[dict, Haplotype]],
)

slots.copyNumber__id = Slot(
    uri=PHENOPACKETS.id,
    name="copyNumber__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.copyNumber__id,
    domain=None,
    range=Optional[str],
)

slots.copyNumber__indefiniteRange = Slot(
    uri=PHENOPACKETS.indefiniteRange,
    name="copyNumber__indefiniteRange",
    curie=PHENOPACKETS.curie("indefiniteRange"),
    model_uri=PHENOPACKETS.copyNumber__indefiniteRange,
    domain=None,
    range=Optional[Union[dict, IndefiniteRange]],
)

slots.copyNumber__literalSequenceExpression = Slot(
    uri=PHENOPACKETS.literalSequenceExpression,
    name="copyNumber__literalSequenceExpression",
    curie=PHENOPACKETS.curie("literalSequenceExpression"),
    model_uri=PHENOPACKETS.copyNumber__literalSequenceExpression,
    domain=None,
    range=Optional[Union[dict, LiteralSequenceExpression]],
)

slots.copyNumber__number = Slot(
    uri=PHENOPACKETS.number,
    name="copyNumber__number",
    curie=PHENOPACKETS.curie("number"),
    model_uri=PHENOPACKETS.copyNumber__number,
    domain=None,
    range=Optional[Union[dict, Number]],
)

slots.copyNumber__repeatedSequenceExpression = Slot(
    uri=PHENOPACKETS.repeatedSequenceExpression,
    name="copyNumber__repeatedSequenceExpression",
    curie=PHENOPACKETS.curie("repeatedSequenceExpression"),
    model_uri=PHENOPACKETS.copyNumber__repeatedSequenceExpression,
    domain=None,
    range=Optional[Union[dict, RepeatedSequenceExpression]],
)

slots.cytobandInterval__end = Slot(
    uri=PHENOPACKETS.end,
    name="cytobandInterval__end",
    curie=PHENOPACKETS.curie("end"),
    model_uri=PHENOPACKETS.cytobandInterval__end,
    domain=None,
    range=Optional[str],
)

slots.cytobandInterval__start = Slot(
    uri=PHENOPACKETS.start,
    name="cytobandInterval__start",
    curie=PHENOPACKETS.curie("start"),
    model_uri=PHENOPACKETS.cytobandInterval__start,
    domain=None,
    range=Optional[str],
)

slots.definiteRange__max = Slot(
    uri=PHENOPACKETS.max,
    name="definiteRange__max",
    curie=PHENOPACKETS.curie("max"),
    model_uri=PHENOPACKETS.definiteRange__max,
    domain=None,
    range=Optional[int],
)

slots.definiteRange__min = Slot(
    uri=PHENOPACKETS.min,
    name="definiteRange__min",
    curie=PHENOPACKETS.curie("min"),
    model_uri=PHENOPACKETS.definiteRange__min,
    domain=None,
    range=Optional[int],
)

slots.derivedSequenceExpression__location = Slot(
    uri=PHENOPACKETS.location,
    name="derivedSequenceExpression__location",
    curie=PHENOPACKETS.curie("location"),
    model_uri=PHENOPACKETS.derivedSequenceExpression__location,
    domain=None,
    range=Optional[Union[dict, SequenceLocation]],
)

slots.derivedSequenceExpression__reverseComplement = Slot(
    uri=PHENOPACKETS.reverseComplement,
    name="derivedSequenceExpression__reverseComplement",
    curie=PHENOPACKETS.curie("reverseComplement"),
    model_uri=PHENOPACKETS.derivedSequenceExpression__reverseComplement,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.feature__gene = Slot(
    uri=PHENOPACKETS.gene,
    name="feature__gene",
    curie=PHENOPACKETS.curie("gene"),
    model_uri=PHENOPACKETS.feature__gene,
    domain=None,
    range=Optional[Union[dict, Gene]],
)

slots.gene__geneId = Slot(
    uri=PHENOPACKETS.geneId,
    name="gene__geneId",
    curie=PHENOPACKETS.curie("geneId"),
    model_uri=PHENOPACKETS.gene__geneId,
    domain=None,
    range=Optional[str],
)

slots.indefiniteRange__comparator = Slot(
    uri=PHENOPACKETS.comparator,
    name="indefiniteRange__comparator",
    curie=PHENOPACKETS.curie("comparator"),
    model_uri=PHENOPACKETS.indefiniteRange__comparator,
    domain=None,
    range=Optional[str],
)

slots.indefiniteRange__value = Slot(
    uri=PHENOPACKETS.value,
    name="indefiniteRange__value",
    curie=PHENOPACKETS.curie("value"),
    model_uri=PHENOPACKETS.indefiniteRange__value,
    domain=None,
    range=Optional[int],
)

slots.literalSequenceExpression__sequence = Slot(
    uri=PHENOPACKETS.sequence,
    name="literalSequenceExpression__sequence",
    curie=PHENOPACKETS.curie("sequence"),
    model_uri=PHENOPACKETS.literalSequenceExpression__sequence,
    domain=None,
    range=Optional[str],
)

slots.location__chromosomeLocation = Slot(
    uri=PHENOPACKETS.chromosomeLocation,
    name="location__chromosomeLocation",
    curie=PHENOPACKETS.curie("chromosomeLocation"),
    model_uri=PHENOPACKETS.location__chromosomeLocation,
    domain=None,
    range=Optional[Union[dict, ChromosomeLocation]],
)

slots.location__sequenceLocation = Slot(
    uri=PHENOPACKETS.sequenceLocation,
    name="location__sequenceLocation",
    curie=PHENOPACKETS.curie("sequenceLocation"),
    model_uri=PHENOPACKETS.location__sequenceLocation,
    domain=None,
    range=Optional[Union[dict, SequenceLocation]],
)

slots.member__allele = Slot(
    uri=PHENOPACKETS.allele,
    name="member__allele",
    curie=PHENOPACKETS.curie("allele"),
    model_uri=PHENOPACKETS.member__allele,
    domain=None,
    range=Optional[Union[dict, Allele]],
)

slots.member__copyNumber = Slot(
    uri=PHENOPACKETS.copyNumber,
    name="member__copyNumber",
    curie=PHENOPACKETS.curie("copyNumber"),
    model_uri=PHENOPACKETS.member__copyNumber,
    domain=None,
    range=Optional[Union[dict, CopyNumber]],
)

slots.member__curie = Slot(
    uri=PHENOPACKETS.curie,
    name="member__curie",
    curie=PHENOPACKETS.curie("curie"),
    model_uri=PHENOPACKETS.member__curie,
    domain=None,
    range=Optional[str],
)

slots.member__haplotype = Slot(
    uri=PHENOPACKETS.haplotype,
    name="member__haplotype",
    curie=PHENOPACKETS.curie("haplotype"),
    model_uri=PHENOPACKETS.member__haplotype,
    domain=None,
    range=Optional[Union[dict, Haplotype]],
)

slots.member__id = Slot(
    uri=PHENOPACKETS.id,
    name="member__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.member__id,
    domain=None,
    range=Optional[str],
)

slots.member__members = Slot(
    uri=PHENOPACKETS.members,
    name="member__members",
    curie=PHENOPACKETS.curie("members"),
    model_uri=PHENOPACKETS.member__members,
    domain=None,
    range=Optional[Union[Union[dict, Member], list[Union[dict, Member]]]],
)

slots.member__text = Slot(
    uri=PHENOPACKETS.text,
    name="member__text",
    curie=PHENOPACKETS.curie("text"),
    model_uri=PHENOPACKETS.member__text,
    domain=None,
    range=Optional[Union[dict, Text]],
)

slots.member__variationSet = Slot(
    uri=PHENOPACKETS.variationSet,
    name="member__variationSet",
    curie=PHENOPACKETS.curie("variationSet"),
    model_uri=PHENOPACKETS.member__variationSet,
    domain=None,
    range=Optional[Union[dict, VariationSet]],
)

slots.molecularVariation__allele = Slot(
    uri=PHENOPACKETS.allele,
    name="molecularVariation__allele",
    curie=PHENOPACKETS.curie("allele"),
    model_uri=PHENOPACKETS.molecularVariation__allele,
    domain=None,
    range=Optional[Union[dict, Allele]],
)

slots.molecularVariation__haplotype = Slot(
    uri=PHENOPACKETS.haplotype,
    name="molecularVariation__haplotype",
    curie=PHENOPACKETS.curie("haplotype"),
    model_uri=PHENOPACKETS.molecularVariation__haplotype,
    domain=None,
    range=Optional[Union[dict, Haplotype]],
)

slots.number__value = Slot(
    uri=PHENOPACKETS.value,
    name="number__value",
    curie=PHENOPACKETS.curie("value"),
    model_uri=PHENOPACKETS.number__value,
    domain=None,
    range=Optional[int],
)

slots.repeatedSequenceExpression__definiteRange = Slot(
    uri=PHENOPACKETS.definiteRange,
    name="repeatedSequenceExpression__definiteRange",
    curie=PHENOPACKETS.curie("definiteRange"),
    model_uri=PHENOPACKETS.repeatedSequenceExpression__definiteRange,
    domain=None,
    range=Optional[Union[dict, DefiniteRange]],
)

slots.repeatedSequenceExpression__derivedSequenceExpression = Slot(
    uri=PHENOPACKETS.derivedSequenceExpression,
    name="repeatedSequenceExpression__derivedSequenceExpression",
    curie=PHENOPACKETS.curie("derivedSequenceExpression"),
    model_uri=PHENOPACKETS.repeatedSequenceExpression__derivedSequenceExpression,
    domain=None,
    range=Optional[Union[dict, DerivedSequenceExpression]],
)

slots.repeatedSequenceExpression__indefiniteRange = Slot(
    uri=PHENOPACKETS.indefiniteRange,
    name="repeatedSequenceExpression__indefiniteRange",
    curie=PHENOPACKETS.curie("indefiniteRange"),
    model_uri=PHENOPACKETS.repeatedSequenceExpression__indefiniteRange,
    domain=None,
    range=Optional[Union[dict, IndefiniteRange]],
)

slots.repeatedSequenceExpression__literalSequenceExpression = Slot(
    uri=PHENOPACKETS.literalSequenceExpression,
    name="repeatedSequenceExpression__literalSequenceExpression",
    curie=PHENOPACKETS.curie("literalSequenceExpression"),
    model_uri=PHENOPACKETS.repeatedSequenceExpression__literalSequenceExpression,
    domain=None,
    range=Optional[Union[dict, LiteralSequenceExpression]],
)

slots.repeatedSequenceExpression__number = Slot(
    uri=PHENOPACKETS.number,
    name="repeatedSequenceExpression__number",
    curie=PHENOPACKETS.curie("number"),
    model_uri=PHENOPACKETS.repeatedSequenceExpression__number,
    domain=None,
    range=Optional[Union[dict, Number]],
)

slots.sequenceExpression__derivedSequenceExpression = Slot(
    uri=PHENOPACKETS.derivedSequenceExpression,
    name="sequenceExpression__derivedSequenceExpression",
    curie=PHENOPACKETS.curie("derivedSequenceExpression"),
    model_uri=PHENOPACKETS.sequenceExpression__derivedSequenceExpression,
    domain=None,
    range=Optional[Union[dict, DerivedSequenceExpression]],
)

slots.sequenceExpression__literalSequenceExpression = Slot(
    uri=PHENOPACKETS.literalSequenceExpression,
    name="sequenceExpression__literalSequenceExpression",
    curie=PHENOPACKETS.curie("literalSequenceExpression"),
    model_uri=PHENOPACKETS.sequenceExpression__literalSequenceExpression,
    domain=None,
    range=Optional[Union[dict, LiteralSequenceExpression]],
)

slots.sequenceExpression__repeatedSequenceExpression = Slot(
    uri=PHENOPACKETS.repeatedSequenceExpression,
    name="sequenceExpression__repeatedSequenceExpression",
    curie=PHENOPACKETS.curie("repeatedSequenceExpression"),
    model_uri=PHENOPACKETS.sequenceExpression__repeatedSequenceExpression,
    domain=None,
    range=Optional[Union[dict, RepeatedSequenceExpression]],
)

slots.sequenceInterval__endDefiniteRange = Slot(
    uri=PHENOPACKETS.endDefiniteRange,
    name="sequenceInterval__endDefiniteRange",
    curie=PHENOPACKETS.curie("endDefiniteRange"),
    model_uri=PHENOPACKETS.sequenceInterval__endDefiniteRange,
    domain=None,
    range=Optional[Union[dict, DefiniteRange]],
)

slots.sequenceInterval__endIndefiniteRange = Slot(
    uri=PHENOPACKETS.endIndefiniteRange,
    name="sequenceInterval__endIndefiniteRange",
    curie=PHENOPACKETS.curie("endIndefiniteRange"),
    model_uri=PHENOPACKETS.sequenceInterval__endIndefiniteRange,
    domain=None,
    range=Optional[Union[dict, IndefiniteRange]],
)

slots.sequenceInterval__endNumber = Slot(
    uri=PHENOPACKETS.endNumber,
    name="sequenceInterval__endNumber",
    curie=PHENOPACKETS.curie("endNumber"),
    model_uri=PHENOPACKETS.sequenceInterval__endNumber,
    domain=None,
    range=Optional[Union[dict, Number]],
)

slots.sequenceInterval__startDefiniteRange = Slot(
    uri=PHENOPACKETS.startDefiniteRange,
    name="sequenceInterval__startDefiniteRange",
    curie=PHENOPACKETS.curie("startDefiniteRange"),
    model_uri=PHENOPACKETS.sequenceInterval__startDefiniteRange,
    domain=None,
    range=Optional[Union[dict, DefiniteRange]],
)

slots.sequenceInterval__startIndefiniteRange = Slot(
    uri=PHENOPACKETS.startIndefiniteRange,
    name="sequenceInterval__startIndefiniteRange",
    curie=PHENOPACKETS.curie("startIndefiniteRange"),
    model_uri=PHENOPACKETS.sequenceInterval__startIndefiniteRange,
    domain=None,
    range=Optional[Union[dict, IndefiniteRange]],
)

slots.sequenceInterval__startNumber = Slot(
    uri=PHENOPACKETS.startNumber,
    name="sequenceInterval__startNumber",
    curie=PHENOPACKETS.curie("startNumber"),
    model_uri=PHENOPACKETS.sequenceInterval__startNumber,
    domain=None,
    range=Optional[Union[dict, Number]],
)

slots.sequenceLocation__id = Slot(
    uri=PHENOPACKETS.id,
    name="sequenceLocation__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.sequenceLocation__id,
    domain=None,
    range=Optional[str],
)

slots.sequenceLocation__sequenceId = Slot(
    uri=PHENOPACKETS.sequenceId,
    name="sequenceLocation__sequenceId",
    curie=PHENOPACKETS.curie("sequenceId"),
    model_uri=PHENOPACKETS.sequenceLocation__sequenceId,
    domain=None,
    range=Optional[str],
)

slots.sequenceLocation__sequenceInterval = Slot(
    uri=PHENOPACKETS.sequenceInterval,
    name="sequenceLocation__sequenceInterval",
    curie=PHENOPACKETS.curie("sequenceInterval"),
    model_uri=PHENOPACKETS.sequenceLocation__sequenceInterval,
    domain=None,
    range=Optional[Union[dict, SequenceInterval]],
)

slots.sequenceState__sequence = Slot(
    uri=PHENOPACKETS.sequence,
    name="sequenceState__sequence",
    curie=PHENOPACKETS.curie("sequence"),
    model_uri=PHENOPACKETS.sequenceState__sequence,
    domain=None,
    range=Optional[str],
)

slots.simpleInterval__end = Slot(
    uri=PHENOPACKETS.end,
    name="simpleInterval__end",
    curie=PHENOPACKETS.curie("end"),
    model_uri=PHENOPACKETS.simpleInterval__end,
    domain=None,
    range=Optional[int],
)

slots.simpleInterval__start = Slot(
    uri=PHENOPACKETS.start,
    name="simpleInterval__start",
    curie=PHENOPACKETS.curie("start"),
    model_uri=PHENOPACKETS.simpleInterval__start,
    domain=None,
    range=Optional[int],
)

slots.systemicVariation__copyNumber = Slot(
    uri=PHENOPACKETS.copyNumber,
    name="systemicVariation__copyNumber",
    curie=PHENOPACKETS.curie("copyNumber"),
    model_uri=PHENOPACKETS.systemicVariation__copyNumber,
    domain=None,
    range=Optional[Union[dict, CopyNumber]],
)

slots.text__definition = Slot(
    uri=PHENOPACKETS.definition,
    name="text__definition",
    curie=PHENOPACKETS.curie("definition"),
    model_uri=PHENOPACKETS.text__definition,
    domain=None,
    range=Optional[str],
)
...
slots.text__id = Slot(
    ...
    name="text__id",
    curie=PHENOPACKETS.curie("id"),
    model_uri=PHENOPACKETS.text__id,
    domain=None,
    range=Optional[str],
)

slots.utilityVariation__text = Slot(
    uri=PHENOPACKETS.text,
    name="utilityVariation__text",
    curie=PHENOPACKETS.curie("text"),
    model_uri=PHENOPACKETS.utilityVariation__text,
    domain=None,
    range=Optional[Union[dict, Text]],
)

slots.utilityVariation__variationSet = Slot(
    uri=PHENOPACKETS.variationSet,
    name="utilityVariation__variationSet",
    curie=PHENOPACKETS.curie("variationSet"),
    model_uri=PHENOPACKETS.utilityVariation__variationSet,
    domain=None,
    range=Optional[Union[dict, VariationSet]],
)

slots.variation__allele = Slot(
    uri=PHENOPACKETS.allele,
    name="variation__allele",
    curie=PHENOPACKETS.curie("allele"),
    model_uri=PHENOPACKETS.variation__allele,
    domain=None,
    range=Optional[Union[dict, Allele]],
)

slots.variation__copyNumber = Slot(
    uri=PHENOPACKETS.copyNumber,
    name="variation__copyNumber",
    curie=PHENOPACKETS.curie("copyNumber"),
    model_uri=PHENOPACKETS.variation__copyNumber,
    domain=None,
    range=Optional[Union[dict, CopyNumber]],
)

slots.variation__haplotype = Slot(
    uri=PHENOPACKETS.haplotype,
    name="variation__haplotype",
    curie=PHENOPACKETS.curie("haplotype"),
    model_uri=PHENOPACKETS.variation__haplotype,
    domain=None,
    range=Optional[Union[dict, Haplotype]],
)

slots.variation__text = Slot(
    uri=PHENOPACKETS.text,
    name="variation__text",
    curie=PHENOPACKETS.curie("text"),
    model_uri=PHENOPACKETS.variation__text,
    domain=None,
    range=Optional[Union[dict, Text]],
)

slots.variation__variationSet = Slot(
    uri=PHENOPACKETS.variationSet,
    name="variation__variationSet",
    curie=PHENOPACKETS.curie("variationSet"),
    model_uri=PHENOPACKETS.variation__variationSet,
    domain=None,
    range=Optional[Union[dict, VariationSet]],
)
