...
class Person(NamedThing):
    ...
    has_interpersonal_relationships: Optional[
        Union[Union[dict, "InterPersonalRelationship"], list[Union[dict, "InterPersonalRelationship"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: list[str], **kwargs: dict[str, Any]):
        ...
        if not isinstance(self.has_interpersonal_relationships, list):
            self.has_interpersonal_relationships = (
                [self.has_interpersonal_relationships] if self.has_interpersonal_relationships is not None else []
            )
        self.has_interpersonal_relationships = [
            v if isinstance(v, InterPersonalRelationship) else InterPersonalRelationship(**as_dict(v))
            for v in self.has_interpersonal_relationships
        ]
...
class NonFamilialRelationshipType(EnumDefinitionImpl):
    ...
    COWORKER_OF = PermissibleValue(text="COWORKER_OF", meaning=FAMREL["70"])
    ROOMMATE_OF = PermissibleValue(text="ROOMMATE_OF", meaning=FAMREL["70"])
...
class GenderType(EnumDefinitionImpl):
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "nonbinary man", PermissibleValue(text="nonbinary man", meaning=GSSO["009254"]))
        setattr(cls, "nonbinary woman", PermissibleValue(text="nonbinary woman", meaning=GSSO["009253"]))
        setattr(cls, "transgender woman", PermissibleValue(text="transgender woman", meaning=GSSO["000384"]))
        setattr(cls, "transgender man", PermissibleValue(text="transgender man", meaning=GSSO["000372"]))
        setattr(cls, "cisgender man", PermissibleValue(text="cisgender man", meaning=GSSO["000371"]))
        setattr(cls, "cisgender woman", PermissibleValue(text="cisgender woman", meaning=GSSO["000385"]))
...
class OrganizationType(EnumDefinitionImpl):
    ...
    charity = PermissibleValue(text="charity", meaning=BIZCODES["001"])
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "non profit", PermissibleValue(text="non profit"))
        setattr(cls, "for profit", PermissibleValue(text="for profit"))
        setattr(cls, "shell company", PermissibleValue(text="shell company"))
        setattr(cls, "loose organization", PermissibleValue(text="loose organization"))
...
slots.has_employment_history = Slot(
    ...
    domain=None,
    range=Optional[Union[Union[dict, EmploymentEvent], list[Union[dict, EmploymentEvent]]]],
)
...
slots.has_interpersonal_relationships = Slot(
    uri=PERSONINFO.has_interpersonal_relationships,
    name="has_interpersonal_relationships",
    curie=PERSONINFO.curie("has_interpersonal_relationships"),
    model_uri=PERSONINFO.has_interpersonal_relationships,
    domain=None,
    range=Optional[Union[Union[dict, InterPersonalRelationship], list[Union[dict, InterPersonalRelationship]]]],
)
...
slots.score = Slot(
    uri=PERSONINFO.score,
    name="score",
    curie=PERSONINFO.curie("score"),
    model_uri=PERSONINFO.score,
    domain=None,
...
slots.depicted_by = Slot(
    uri=PERSONINFO.depicted_by,
    name="depicted_by",
    curie=PERSONINFO.curie("depicted_by"),
    model_uri=PERSONINFO.depicted_by,
    domain=None,
    range=Optional[Union[str, ImageURL]],
)
...
slots.subtype = Slot(
    uri=PERSONINFO.subtype,
    name="subtype",
    curie=PERSONINFO.curie("subtype"),
    model_uri=PERSONINFO.subtype,
    domain=None,
    range=Optional[Union[str, ConceptId]],
)
...
slots.categories = Slot(
    uri=PERSONINFO.categories,
    name="categories",
    curie=PERSONINFO.curie("categories"),
    model_uri=PERSONINFO.categories,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.salary = Slot(
    uri=PERSONINFO.salary,
    name="salary",
    curie=PERSONINFO.curie("salary"),
    model_uri=PERSONINFO.salary,
    domain=None,
    range=Optional[Union[Decimal, SalaryType]],
)

slots.min_salary = Slot(
    uri=PERSONINFO.min_salary,
    name="min_salary",
    curie=PERSONINFO.curie("min_salary"),
    model_uri=PERSONINFO.min_salary,
    domain=None,
    range=Optional[Union[Decimal, SalaryType]],
)
...
slots.concept__code_system = Slot(
    uri=PERSONINFO.code_system,
    name="concept__code_system",
    curie=PERSONINFO.curie("code_system"),
    model_uri=PERSONINFO.concept__code_system,
    domain=None,
    range=Optional[Union[str, CodeSystemId]],
)

slots.concept__mappings = Slot(
    uri=SKOS.exactMatch,
    name="concept__mappings",
    curie=SKOS.curie("exactMatch"),
    model_uri=PERSONINFO.concept__mappings,
    domain=None,
    range=Optional[Union[Union[str, CrossReference], list[Union[str, CrossReference]]]],
)
...
slots.container__organizations = Slot(
    uri=PERSONINFO.organizations,
    name="container__organizations",
    curie=PERSONINFO.curie("organizations"),
    model_uri=PERSONINFO.container__organizations,
    domain=None,
...
slots.Organization_categories = Slot(
    uri=PERSONINFO.categories,
    name="Organization_categories",
    curie=PERSONINFO.curie("categories"),
    model_uri=PERSONINFO.Organization_categories,
    domain=Organization,
    range=Optional[Union[Union[str, "OrganizationType"], list[Union[str, "OrganizationType"]]]],
)
...
slots.InterPersonalRelationship_type = Slot(
    uri=PERSONINFO.type,
    name="InterPersonalRelationship_type",
    curie=PERSONINFO.curie("type"),
    model_uri=PERSONINFO.InterPersonalRelationship_type,
    domain=InterPersonalRelationship,
    range=str,
)

slots.InterPersonalRelationship_related_to = Slot(
    uri=PERSONINFO.related_to,
    name="InterPersonalRelationship_related to",
    curie=PERSONINFO.curie("related_to"),
    model_uri=PERSONINFO.InterPersonalRelationship_related_to,
    domain=InterPersonalRelationship,
    range=Union[str, PersonId],
)
