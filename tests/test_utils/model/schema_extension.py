# Auto generated from schema_extension.yaml by pythongen.py version: 0.9.0
# Generation date: 2022-01-24T16:08:40
# Schema: schema_extension
#
# id: https://w3id.org/linkml/tests/schema_extension
# description: Tests extending the metamodel
...
SCHEMA_EXTENSIONS = CurieNamespace('schema_extensions', 'https://w3id.org/linkml/tests/schema_extension/')
SH = CurieNamespace('sh', 'https://w3id.org/shacl/')
SKOS = CurieNamespace('skos', 'http://www.w3.org/2004/02/skos/core#')
SWRL = CurieNamespace('swrl', 'http://www.w3.org/2003/11/swrl#')
XSD = CurieNamespace('xsd', 'http://www.w3.org/2001/XMLSchema#')
DEFAULT_ = SCHEMA_EXTENSIONS
...
class ExtSchemaName(SchemaDefinitionName):
    pass
...
class ExtSlotName(SlotDefinitionName):
    pass
...
class ExtClassName(ClassDefinitionName):
    pass
...
class CommonMetadata(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.CommonMetadata
...
class Element(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.Element
...
class SchemaDefinition(Element):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.SchemaDefinition
...
@dataclass
class ExtSchema(SchemaDefinition):
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ExtSchema
    class_class_curie: ClassVar[str] = "schema_extensions:ExtSchema"
    class_name: ClassVar[str] = "ExtSchema"
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ExtSchema

    name: Union[str, ExtSchemaName] = None
    id: Union[str, URI] = None
    classes: Optional[Union[Dict[Union[str, ExtClassName], Union[dict, "ExtClass"]], List[Union[dict, "ExtClass"]]]] = empty_dict()
    slots: Optional[Union[Union[str, ExtSlotName], List[Union[str, ExtSlotName]]]] = empty_list()

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.name):
            self.MissingRequiredField("name")
        if not isinstance(self.name, ExtSchemaName):
            self.name = ExtSchemaName(self.name)

        self._normalize_inlined_as_dict(slot_name="classes", slot_type=ExtClass, key_name="name", keyed=True)

        if not isinstance(self.slots, list):
            self.slots = [self.slots] if self.slots is not None else []
        self.slots = [v if isinstance(v, ExtSlotName) else ExtSlotName(v) for v in self.slots]
...
class AnonymousTypeExpression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.AnonymousTypeExpression
...
class TypeDefinition(Element):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.TypeDefinition
...
class SubsetDefinition(Element):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.SubsetDefinition
...
class Definition(Element):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.Definition
...
class EnumDefinition(Element):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.EnumDefinition
...
class Expression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.Expression
...
class TypeExpression(Expression):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.TypeExpression
...
class AnonymousExpression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.AnonymousExpression
...
class SlotExpression(Expression):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.SlotExpression
...
class AnonymousSlotExpression(AnonymousExpression):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.AnonymousSlotExpression
...
class SlotDefinition(Definition):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.SlotDefinition
...
@dataclass
class ExtSlot(SlotDefinition):
    _inherited_slots: ClassVar[List[str]] = ["domain", "multivalued", "inherited", "readonly", "ifabsent", "inlined", "inlined_as_list", "key", "identifier", "designates_type", "role", "range", "required", "recommended", "minimum_value", "maximum_value", "pattern", "equals_string", "equals_string_in", "equals_number", "equals_expression", "minimum_cardinality", "maximum_cardinality"]

    class_class_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ExtSlot
    class_class_curie: ClassVar[str] = "schema_extensions:ExtSlot"
    class_name: ClassVar[str] = "ExtSlot"
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ExtSlot

    name: Union[str, ExtSlotName] = None
    ext_info: Optional[str] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.name):
            self.MissingRequiredField("name")
        if not isinstance(self.name, ExtSlotName):
            self.name = ExtSlotName(self.name)

        if self.ext_info is not None and not isinstance(self.ext_info, str):
            self.ext_info = str(self.ext_info)
...
class ClassExpression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ClassExpression
...
class AnonymousClassExpression(AnonymousExpression):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.AnonymousClassExpression
...
class ClassDefinition(Definition):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ClassDefinition
...
@dataclass
class ExtClass(ClassDefinition):
    _inherited_slots: ClassVar[List[str]] = ["defining_slots"]

    class_class_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ExtClass
    class_class_curie: ClassVar[str] = "schema_extensions:ExtClass"
    class_name: ClassVar[str] = "ExtClass"
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ExtClass

    name: Union[str, ExtClassName] = None
    ext_info: Optional[str] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.name):
            self.MissingRequiredField("name")
        if not isinstance(self.name, ExtClassName):
            self.name = ExtClassName(self.name)
...
class ClassLevelRule(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ClassLevelRule
...
class ClassRule(ClassLevelRule):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.ClassRule
...
class Prefix(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.Prefix
...
class LocalName(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.LocalName
...
class Example(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.Example
...
class AltDescription(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.AltDescription
...
class PermissibleValue(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.PermissibleValue
...
class UniqueKey(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SCHEMA_EXTENSIONS.UniqueKey
...
slots.ext_info = Slot(uri=SCHEMA_EXTENSIONS.ext_info, name="ext_info", curie=SCHEMA_EXTENSIONS.curie('ext_info'),
                   model_uri=SCHEMA_EXTENSIONS.ext_info, domain=None, range=Optional[str])

slots.name = Slot(uri=RDFS.label, name="name", curie=RDFS.curie('label'),
                   model_uri=SCHEMA_EXTENSIONS.name, domain=Element, range=Union[str, ElementName], mappings = [SCHEMA.name])

slots.title = Slot(uri=DCTERMS.title, name="title", curie=DCTERMS.curie('title'),
                   model_uri=SCHEMA_EXTENSIONS.title, domain=Element, range=Optional[str])

slots.conforms_to = Slot(uri=DCTERMS.conformsTo, name="conforms_to", curie=DCTERMS.curie('conformsTo'),
                   model_uri=SCHEMA_EXTENSIONS.conforms_to, domain=Element, range=Optional[str])

slots.definition_uri = Slot(uri=LINKML.definition_uri, name="definition_uri", curie=LINKML.curie('definition_uri'),
                   model_uri=SCHEMA_EXTENSIONS.definition_uri, domain=Element, range=Optional[Union[str, URIorCURIE]])

slots.id_prefixes = Slot(uri=LINKML.id_prefixes, name="id_prefixes", curie=LINKML.curie('id_prefixes'),
                   model_uri=SCHEMA_EXTENSIONS.id_prefixes, domain=Element, range=Optional[Union[Union[str, NCName], List[Union[str, NCName]]]])

slots.description = Slot(uri=SKOS.definition, name="description", curie=SKOS.curie('definition'),
                   model_uri=SCHEMA_EXTENSIONS.description, domain=Element, range=Optional[str])

slots.aliases = Slot(uri=SKOS.altLabel, name="aliases", curie=SKOS.curie('altLabel'),
                   model_uri=SCHEMA_EXTENSIONS.aliases, domain=Element, range=Optional[Union[str, List[str]]])

slots.deprecated = Slot(uri=LINKML.deprecated, name="deprecated", curie=LINKML.curie('deprecated'),
                   model_uri=SCHEMA_EXTENSIONS.deprecated, domain=Element, range=Optional[str])

slots.todos = Slot(uri=LINKML.todos, name="todos", curie=LINKML.curie('todos'),
                   model_uri=SCHEMA_EXTENSIONS.todos, domain=Element, range=Optional[Union[str, List[str]]])

slots.notes = Slot(uri=SKOS.editorialNote, name="notes", curie=SKOS.curie('editorialNote'),
                   model_uri=SCHEMA_EXTENSIONS.notes, domain=Element, range=Optional[Union[str, List[str]]])

slots.comments = Slot(uri=SKOS.note, name="comments", curie=SKOS.curie('note'),
                   model_uri=SCHEMA_EXTENSIONS.comments, domain=Element, range=Optional[Union[str, List[str]]])

slots.in_subset = Slot(uri=OIO.inSubset, name="in_subset", curie=OIO.curie('inSubset'),
                   model_uri=SCHEMA_EXTENSIONS.in_subset, domain=Element, range=Optional[Union[Union[str, SubsetDefinitionName], List[Union[str, SubsetDefinitionName]]]])

slots.from_schema = Slot(uri=SKOS.inScheme, name="from_schema", curie=SKOS.curie('inScheme'),
                   model_uri=SCHEMA_EXTENSIONS.from_schema, domain=Element, range=Optional[Union[str, URI]])

slots.imported_from = Slot(uri=LINKML.imported_from, name="imported_from", curie=LINKML.curie('imported_from'),
                   model_uri=SCHEMA_EXTENSIONS.imported_from, domain=Element, range=Optional[str])

slots.see_also = Slot(uri=RDFS.seeAlso, name="see_also", curie=RDFS.curie('seeAlso'),
                   model_uri=SCHEMA_EXTENSIONS.see_also, domain=Element, range=Optional[Union[Union[str, URIorCURIE], List[Union[str, URIorCURIE]]]])

slots.created_by = Slot(uri=PAV.createdBy, name="created_by", curie=PAV.curie('createdBy'),
                   model_uri=SCHEMA_EXTENSIONS.created_by, domain=Element, range=Optional[Union[str, URIorCURIE]])

slots.created_on = Slot(uri=PAV.createdOn, name="created_on", curie=PAV.curie('createdOn'),
                   model_uri=SCHEMA_EXTENSIONS.created_on, domain=Element, range=Optional[Union[str, XSDDateTime]])

slots.last_updated_on = Slot(uri=PAV.lastUpdatedOn, name="last_updated_on", curie=PAV.curie('lastUpdatedOn'),
                   model_uri=SCHEMA_EXTENSIONS.last_updated_on, domain=Element, range=Optional[Union[str, XSDDateTime]])

slots.modified_by = Slot(uri=OSLC.modifiedBy, name="modified_by", curie=OSLC.curie('modifiedBy'),
                   model_uri=SCHEMA_EXTENSIONS.modified_by, domain=Element, range=Optional[Union[str, URIorCURIE]])

slots.status = Slot(uri=BIBO.status, name="status", curie=BIBO.curie('status'),
                   model_uri=SCHEMA_EXTENSIONS.status, domain=Element, range=Optional[Union[str, URIorCURIE]])

slots.is_a = Slot(uri=LINKML.is_a, name="is_a", curie=LINKML.curie('is_a'),
                   model_uri=SCHEMA_EXTENSIONS.is_a, domain=Definition, range=Optional[Union[str, DefinitionName]])

slots.abstract = Slot(uri=LINKML.abstract, name="abstract", curie=LINKML.curie('abstract'),
                   model_uri=SCHEMA_EXTENSIONS.abstract, domain=Definition, range=Optional[Union[bool, Bool]])

slots.mixin = Slot(uri=LINKML.mixin, name="mixin", curie=LINKML.curie('mixin'),
                   model_uri=SCHEMA_EXTENSIONS.mixin, domain=Definition, range=Optional[Union[bool, Bool]])

slots.mixins = Slot(uri=LINKML.mixins, name="mixins", curie=LINKML.curie('mixins'),
                   model_uri=SCHEMA_EXTENSIONS.mixins, domain=Definition, range=Optional[Union[Union[str, DefinitionName], List[Union[str, DefinitionName]]]])

slots.apply_to = Slot(uri=LINKML.apply_to, name="apply_to", curie=LINKML.curie('apply_to'),
                   model_uri=SCHEMA_EXTENSIONS.apply_to, domain=Definition, range=Optional[Union[Union[str, DefinitionName], List[Union[str, DefinitionName]]]])

slots.values_from = Slot(uri=LINKML.values_from, name="values_from", curie=LINKML.curie('values_from'),
                   model_uri=SCHEMA_EXTENSIONS.values_from, domain=Definition, range=Optional[Union[Union[str, URIorCURIE], List[Union[str, URIorCURIE]]]])

slots.code_set = Slot(uri=LINKML.code_set, name="code_set", curie=LINKML.curie('code_set'),
                   model_uri=SCHEMA_EXTENSIONS.code_set, domain=EnumDefinition, range=Optional[Union[str, URIorCURIE]])

slots.code_set_version = Slot(uri=LINKML.code_set_version, name="code_set_version", curie=LINKML.curie('code_set_version'),
                   model_uri=SCHEMA_EXTENSIONS.code_set_version, domain=EnumDefinition, range=Optional[str])

slots.code_set_tag = Slot(uri=LINKML.code_set_tag, name="code_set_tag", curie=LINKML.curie('code_set_tag'),
                   model_uri=SCHEMA_EXTENSIONS.code_set_tag, domain=EnumDefinition, range=Optional[str])

slots.pv_formula = Slot(uri=LINKML.pv_formula, name="pv_formula", curie=LINKML.curie('pv_formula'),
                   model_uri=SCHEMA_EXTENSIONS.pv_formula, domain=EnumDefinition, range=Optional[Union[str, "PvFormulaOptions"]])
...
slots.permissible_values = Slot(uri=LINKML.permissible_values, name="permissible_values", curie=LINKML.curie('permissible_values'),
                   model_uri=SCHEMA_EXTENSIONS.permissible_values, domain=EnumDefinition, range=Optional[Union[Dict[Union[str, PermissibleValueText], Union[dict, "PermissibleValue"]], List[Union[dict, "PermissibleValue"]]]])

slots.text = Slot(uri=LINKML.text, name="text", curie=LINKML.curie('text'),
                   model_uri=SCHEMA_EXTENSIONS.text, domain=PermissibleValue, range=Union[str, PermissibleValueText])

slots.meaning = Slot(uri=LINKML.meaning, name="meaning", curie=LINKML.curie('meaning'),
                   model_uri=SCHEMA_EXTENSIONS.meaning, domain=PermissibleValue, range=Optional[Union[str, URIorCURIE]])

slots.id = Slot(uri=LINKML.id, name="id", curie=LINKML.curie('id'),
                   model_uri=SCHEMA_EXTENSIONS.id, domain=SchemaDefinition, range=Union[str, URI])

slots.emit_prefixes = Slot(uri=LINKML.emit_prefixes, name="emit_prefixes", curie=LINKML.curie('emit_prefixes'),
                   model_uri=SCHEMA_EXTENSIONS.emit_prefixes, domain=SchemaDefinition, range=Optional[Union[Union[str, NCName], List[Union[str, NCName]]]])

slots.version = Slot(uri=PAV.version, name="version", curie=PAV.curie('version'),
                   model_uri=SCHEMA_EXTENSIONS.version, domain=SchemaDefinition, range=Optional[str], mappings = [SCHEMA.schemaVersion])

slots.imports = Slot(uri=LINKML.imports, name="imports", curie=LINKML.curie('imports'),
                   model_uri=SCHEMA_EXTENSIONS.imports, domain=SchemaDefinition, range=Optional[Union[Union[str, URIorCURIE], List[Union[str, URIorCURIE]]]])

slots.license = Slot(uri=DCTERMS.license, name="license", curie=DCTERMS.curie('license'),
                   model_uri=SCHEMA_EXTENSIONS.license, domain=SchemaDefinition, range=Optional[str])

slots.default_curi_maps = Slot(uri=LINKML.default_curi_maps, name="default_curi_maps", curie=LINKML.curie('default_curi_maps'),
                   model_uri=SCHEMA_EXTENSIONS.default_curi_maps, domain=SchemaDefinition, range=Optional[Union[str, List[str]]])

slots.default_prefix = Slot(uri=LINKML.default_prefix, name="default_prefix", curie=LINKML.curie('default_prefix'),
                   model_uri=SCHEMA_EXTENSIONS.default_prefix, domain=SchemaDefinition, range=Optional[str])

slots.default_range = Slot(uri=LINKML.default_range, name="default_range", curie=LINKML.curie('default_range'),
                   model_uri=SCHEMA_EXTENSIONS.default_range, domain=SchemaDefinition, range=Optional[Union[str, TypeDefinitionName]])

slots.subsets = Slot(uri=LINKML.subsets, name="subsets", curie=LINKML.curie('subsets'),
                   model_uri=SCHEMA_EXTENSIONS.subsets, domain=SchemaDefinition, range=Optional[Union[Dict[Union[str, SubsetDefinitionName], Union[dict, "SubsetDefinition"]], List[Union[dict, "SubsetDefinition"]]]])

slots.types = Slot(uri=LINKML.types, name="types", curie=LINKML.curie('types'),
                   model_uri=SCHEMA_EXTENSIONS.types, domain=SchemaDefinition, range=Optional[Union[Dict[Union[str, TypeDefinitionName], Union[dict, "TypeDefinition"]], List[Union[dict, "TypeDefinition"]]]])

slots.enums = Slot(uri=LINKML.enums, name="enums", curie=LINKML.curie('enums'),
                   model_uri=SCHEMA_EXTENSIONS.enums, domain=SchemaDefinition, range=Optional[Union[Dict[Union[str, EnumDefinitionName], Union[dict, "EnumDefinition"]], List[Union[dict, "EnumDefinition"]]]])

slots.slot_definitions = Slot(uri=LINKML.slots, name="slot_definitions", curie=LINKML.curie('slots'),
                   model_uri=SCHEMA_EXTENSIONS.slot_definitions, domain=SchemaDefinition, range=Optional[Union[Dict[Union[str, SlotDefinitionName], Union[dict, "SlotDefinition"]], List[Union[dict, "SlotDefinition"]]]])

slots.classes = Slot(uri=LINKML.classes, name="classes", curie=LINKML.curie('classes'),
                   model_uri=SCHEMA_EXTENSIONS.classes, domain=SchemaDefinition, range=Optional[Union[Dict[Union[str, ClassDefinitionName], Union[dict, "ClassDefinition"]], List[Union[dict, "ClassDefinition"]]]])

slots.metamodel_version = Slot(uri=LINKML.metamodel_version, name="metamodel_version", curie=LINKML.curie('metamodel_version'),
                   model_uri=SCHEMA_EXTENSIONS.metamodel_version, domain=SchemaDefinition, range=Optional[str])

slots.source_file = Slot(uri=LINKML.source_file, name="source_file", curie=LINKML.curie('source_file'),
                   model_uri=SCHEMA_EXTENSIONS.source_file, domain=SchemaDefinition, range=Optional[str])

slots.source_file_date = Slot(uri=LINKML.source_file_date, name="source_file_date", curie=LINKML.curie('source_file_date'),
                   model_uri=SCHEMA_EXTENSIONS.source_file_date, domain=SchemaDefinition, range=Optional[Union[str, XSDDateTime]])

slots.source_file_size = Slot(uri=LINKML.source_file_size, name="source_file_size", curie=LINKML.curie('source_file_size'),
                   model_uri=SCHEMA_EXTENSIONS.source_file_size, domain=SchemaDefinition, range=Optional[int])

slots.generation_date = Slot(uri=LINKML.generation_date, name="generation_date", curie=LINKML.curie('generation_date'),
                   model_uri=SCHEMA_EXTENSIONS.generation_date, domain=SchemaDefinition, range=Optional[Union[str, XSDDateTime]])

slots.slots = Slot(uri=LINKML.slots, name="slots", curie=LINKML.curie('slots'),
                   model_uri=SCHEMA_EXTENSIONS.slots, domain=ClassDefinition, range=Optional[Union[Union[str, SlotDefinitionName], List[Union[str, SlotDefinitionName]]]])

slots.slot_usage = Slot(uri=LINKML.slot_usage, name="slot_usage", curie=LINKML.curie('slot_usage'),
                   model_uri=SCHEMA_EXTENSIONS.slot_usage, domain=ClassDefinition, range=Optional[Union[Dict[Union[str, SlotDefinitionName], Union[dict, SlotDefinition]], List[Union[dict, SlotDefinition]]]])

slots.range_expression = Slot(uri=LINKML.range_expression, name="range_expression", curie=LINKML.curie('range_expression'),
                   model_uri=SCHEMA_EXTENSIONS.range_expression, domain=None, range=Optional[Union[dict, "AnonymousClassExpression"]])

slots.boolean_slot = Slot(uri=LINKML.boolean_slot, name="boolean_slot", curie=LINKML.curie('boolean_slot'),
                   model_uri=SCHEMA_EXTENSIONS.boolean_slot, domain=None, range=Optional[Union[Union[dict, Expression], List[Union[dict, Expression]]]])

slots.any_of = Slot(uri=LINKML.any_of, name="any_of", curie=LINKML.curie('any_of'),
                   model_uri=SCHEMA_EXTENSIONS.any_of, domain=None, range=Optional[Union[Union[dict, Expression], List[Union[dict, Expression]]]])

slots.exactly_one_of = Slot(uri=LINKML.exactly_one_of, name="exactly_one_of", curie=LINKML.curie('exactly_one_of'),
                   model_uri=SCHEMA_EXTENSIONS.exactly_one_of, domain=None, range=Optional[Union[Union[dict, Expression], List[Union[dict, Expression]]]])

slots.none_of = Slot(uri=LINKML.none_of, name="none_of", curie=LINKML.curie('none_of'),
                   model_uri=SCHEMA_EXTENSIONS.none_of, domain=None, range=Optional[Union[Union[dict, Expression], List[Union[dict, Expression]]]])

slots.all_of = Slot(uri=LINKML.all_of, name="all_of", curie=LINKML.curie('all_of'),
                   model_uri=SCHEMA_EXTENSIONS.all_of, domain=None, range=Optional[Union[Union[dict, Expression], List[Union[dict, Expression]]]])

slots.preconditions = Slot(uri=SH.condition, name="preconditions", curie=SH.curie('condition'),
                   model_uri=SCHEMA_EXTENSIONS.preconditions, domain=None, range=Optional[Union[dict, AnonymousClassExpression]])

slots.postconditions = Slot(uri=LINKML.postconditions, name="postconditions", curie=LINKML.curie('postconditions'),
                   model_uri=SCHEMA_EXTENSIONS.postconditions, domain=None, range=Optional[Union[dict, AnonymousClassExpression]])

slots.elseconditions = Slot(uri=LINKML.elseconditions, name="elseconditions", curie=LINKML.curie('elseconditions'),
                   model_uri=SCHEMA_EXTENSIONS.elseconditions, domain=None, range=Optional[Union[dict, AnonymousClassExpression]])

slots.bidirectional = Slot(uri=LINKML.bidirectional, name="bidirectional", curie=LINKML.curie('bidirectional'),
                   model_uri=SCHEMA_EXTENSIONS.bidirectional, domain=None, range=Optional[Union[bool, Bool]])

slots.open_world = Slot(uri=LINKML.open_world, name="open_world", curie=LINKML.curie('open_world'),
                   model_uri=SCHEMA_EXTENSIONS.open_world, domain=None, range=Optional[Union[bool, Bool]])

slots.precedence = Slot(uri=SH.order, name="precedence", curie=SH.curie('order'),
                   model_uri=SCHEMA_EXTENSIONS.precedence, domain=None, range=Optional[int])

slots.deactivated = Slot(uri=SH.deactivated, name="deactivated", curie=SH.curie('deactivated'),
                   model_uri=SCHEMA_EXTENSIONS.deactivated, domain=None, range=Optional[Union[bool, Bool]])

slots.rules = Slot(uri=SH.rule, name="rules", curie=SH.curie('rule'),
                   model_uri=SCHEMA_EXTENSIONS.rules, domain=ClassDefinition, range=Optional[Union[Union[dict, "ClassRule"], List[Union[dict, "ClassRule"]]]])
...
slots.classification_rules = Slot(uri=LINKML.classification_rules, name="classification_rules", curie=LINKML.curie('classification_rules'),
                   model_uri=SCHEMA_EXTENSIONS.classification_rules, domain=ClassDefinition, range=Optional[Union[Union[dict, AnonymousClassExpression], List[Union[dict, AnonymousClassExpression]]]])

slots.slot_conditions = Slot(uri=LINKML.slot_conditions, name="slot_conditions", curie=LINKML.curie('slot_conditions'),
                   model_uri=SCHEMA_EXTENSIONS.slot_conditions, domain=None, range=Optional[Union[Dict[Union[str, SlotDefinitionName], Union[dict, SlotDefinition]], List[Union[dict, SlotDefinition]]]])

slots.attributes = Slot(uri=LINKML.attributes, name="attributes", curie=LINKML.curie('attributes'),
                   model_uri=SCHEMA_EXTENSIONS.attributes, domain=ClassDefinition, range=Optional[Union[Dict[Union[str, SlotDefinitionName], Union[dict, SlotDefinition]], List[Union[dict, SlotDefinition]]]])

slots.class_uri = Slot(uri=LINKML.class_uri, name="class_uri", curie=LINKML.curie('class_uri'),
                   model_uri=SCHEMA_EXTENSIONS.class_uri, domain=ClassDefinition, range=Optional[Union[str, URIorCURIE]])

slots.subclass_of = Slot(uri=RDFS.subClassOf, name="subclass_of", curie=RDFS.curie('subClassOf'),
                   model_uri=SCHEMA_EXTENSIONS.subclass_of, domain=ClassDefinition, range=Optional[Union[str, URIorCURIE]])

slots.defining_slots = Slot(uri=LINKML.defining_slots, name="defining_slots", curie=LINKML.curie('defining_slots'),
                   model_uri=SCHEMA_EXTENSIONS.defining_slots, domain=ClassDefinition, range=Optional[Union[Union[str, SlotDefinitionName], List[Union[str, SlotDefinitionName]]]])

slots.union_of = Slot(uri=LINKML.union_of, name="union_of", curie=LINKML.curie('union_of'),
                   model_uri=SCHEMA_EXTENSIONS.union_of, domain=ClassDefinition, range=Optional[Union[Union[str, ClassDefinitionName], List[Union[str, ClassDefinitionName]]]])

slots.tree_root = Slot(uri=LINKML.tree_root, name="tree_root", curie=LINKML.curie('tree_root'),
                   model_uri=SCHEMA_EXTENSIONS.tree_root, domain=ClassDefinition, range=Optional[Union[bool, Bool]])

slots.unique_keys = Slot(uri=LINKML.unique_keys, name="unique_keys", curie=LINKML.curie('unique_keys'),
                   model_uri=SCHEMA_EXTENSIONS.unique_keys, domain=ClassDefinition, range=Optional[Union[Union[dict, "UniqueKey"], List[Union[dict, "UniqueKey"]]]], mappings = [OWL.hasKey])

slots.unique_key_slots = Slot(uri=LINKML.unique_key_slots, name="unique_key_slots", curie=LINKML.curie('unique_key_slots'),
                   model_uri=SCHEMA_EXTENSIONS.unique_key_slots, domain=UniqueKey, range=Union[Union[str, SlotDefinitionName], List[Union[str, SlotDefinitionName]]])

slots.domain = Slot(uri=LINKML.domain, name="domain", curie=LINKML.curie('domain'),
                   model_uri=SCHEMA_EXTENSIONS.domain, domain=SlotDefinition, range=Optional[Union[str, ClassDefinitionName]])

slots.range = Slot(uri=LINKML.range, name="range", curie=LINKML.curie('range'),
                   model_uri=SCHEMA_EXTENSIONS.range, domain=SlotDefinition, range=Optional[Union[str, ElementName]])

slots.slot_uri = Slot(uri=LINKML.slot_uri, name="slot_uri", curie=LINKML.curie('slot_uri'),
                   model_uri=SCHEMA_EXTENSIONS.slot_uri, domain=SlotDefinition, range=Optional[Union[str, URIorCURIE]])

slots.multivalued = Slot(uri=LINKML.multivalued, name="multivalued", curie=LINKML.curie('multivalued'),
                   model_uri=SCHEMA_EXTENSIONS.multivalued, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.inherited = Slot(uri=LINKML.inherited, name="inherited", curie=LINKML.curie('inherited'),
                   model_uri=SCHEMA_EXTENSIONS.inherited, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.readonly = Slot(uri=LINKML.readonly, name="readonly", curie=LINKML.curie('readonly'),
                   model_uri=SCHEMA_EXTENSIONS.readonly, domain=SlotDefinition, range=Optional[str])

slots.ifabsent = Slot(uri=LINKML.ifabsent, name="ifabsent", curie=LINKML.curie('ifabsent'),
                   model_uri=SCHEMA_EXTENSIONS.ifabsent, domain=SlotDefinition, range=Optional[str])
...
slots.value_specification_constant = Slot(uri=LINKML.value_specification_constant, name="value_specification_constant", curie=LINKML.curie('value_specification_constant'),
                   model_uri=SCHEMA_EXTENSIONS.value_specification_constant, domain=None, range=Optional[str])
...
slots.minimum_cardinality = Slot(uri=LINKML.minimum_cardinality, name="minimum_cardinality", curie=LINKML.curie('minimum_cardinality'),
                   model_uri=SCHEMA_EXTENSIONS.minimum_cardinality, domain=None, range=Optional[int])
...
slots.maximum_cardinality = Slot(uri=LINKML.maximum_cardinality, name="maximum_cardinality", curie=LINKML.curie('maximum_cardinality'),
                   model_uri=SCHEMA_EXTENSIONS.maximum_cardinality, domain=None, range=Optional[int])

slots.equals_string_in = Slot(uri=LINKML.equals_string_in, name="equals_string_in", curie=LINKML.curie('equals_string_in'),
                   model_uri=SCHEMA_EXTENSIONS.equals_string_in, domain=None, range=Optional[Union[str, List[str]]])

slots.equals_number_in = Slot(uri=LINKML.equals_number_in, name="equals_number_in", curie=LINKML.curie('equals_number_in'),
                   model_uri=SCHEMA_EXTENSIONS.equals_number_in, domain=None, range=Optional[Union[int, List[int]]])

slots.has_member = Slot(uri=LINKML.has_member, name="has_member", curie=LINKML.curie('has_member'),
                   model_uri=SCHEMA_EXTENSIONS.has_member, domain=None, range=Optional[Union[dict, AnonymousSlotExpression]])

slots.all_members = Slot(uri=LINKML.all_members, name="all_members", curie=LINKML.curie('all_members'),
                   model_uri=SCHEMA_EXTENSIONS.all_members, domain=None, range=Optional[Union[Dict[Union[str, SlotDefinitionName], Union[dict, SlotDefinition]], List[Union[dict, SlotDefinition]]]])

slots.singular_name = Slot(uri=SKOS.altLabel, name="singular_name", curie=SKOS.curie('altLabel'),
                   model_uri=SCHEMA_EXTENSIONS.singular_name, domain=SlotDefinition, range=Optional[str])

slots.required = Slot(uri=LINKML.required, name="required", curie=LINKML.curie('required'),
                   model_uri=SCHEMA_EXTENSIONS.required, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.recommended = Slot(uri=LINKML.recommended, name="recommended", curie=LINKML.curie('recommended'),
                   model_uri=SCHEMA_EXTENSIONS.recommended, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.inlined = Slot(uri=LINKML.inlined, name="inlined", curie=LINKML.curie('inlined'),
                   model_uri=SCHEMA_EXTENSIONS.inlined, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.inlined_as_list = Slot(uri=LINKML.inlined_as_list, name="inlined_as_list", curie=LINKML.curie('inlined_as_list'),
                   model_uri=SCHEMA_EXTENSIONS.inlined_as_list, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.key = Slot(uri=LINKML.key, name="key", curie=LINKML.curie('key'),
                   model_uri=SCHEMA_EXTENSIONS.key, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.identifier = Slot(uri=LINKML.identifier, name="identifier", curie=LINKML.curie('identifier'),
                   model_uri=SCHEMA_EXTENSIONS.identifier, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.designates_type = Slot(uri=LINKML.designates_type, name="designates_type", curie=LINKML.curie('designates_type'),
                   model_uri=SCHEMA_EXTENSIONS.designates_type, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.alias = Slot(uri=SKOS.prefLabel, name="alias", curie=SKOS.curie('prefLabel'),
                   model_uri=SCHEMA_EXTENSIONS.alias, domain=SlotDefinition, range=Optional[str])

slots.owner = Slot(uri=LINKML.owner, name="owner", curie=LINKML.curie('owner'),
                   model_uri=SCHEMA_EXTENSIONS.owner, domain=SlotDefinition, range=Optional[Union[str, DefinitionName]])

slots.domain_of = Slot(uri=LINKML.domain_of, name="domain_of", curie=LINKML.curie('domain_of'),
                   model_uri=SCHEMA_EXTENSIONS.domain_of, domain=SlotDefinition, range=Optional[Union[Union[str, ClassDefinitionName], List[Union[str, ClassDefinitionName]]]])

slots.is_usage_slot = Slot(uri=LINKML.is_usage_slot, name="is_usage_slot", curie=LINKML.curie('is_usage_slot'),
                   model_uri=SCHEMA_EXTENSIONS.is_usage_slot, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.usage_slot_name = Slot(uri=LINKML.usage_slot_name, name="usage_slot_name", curie=LINKML.curie('usage_slot_name'),
                   model_uri=SCHEMA_EXTENSIONS.usage_slot_name, domain=SlotDefinition, range=Optional[str])

slots.subproperty_of = Slot(uri=RDFS.subPropertyOf, name="subproperty_of", curie=RDFS.curie('subPropertyOf'),
                   model_uri=SCHEMA_EXTENSIONS.subproperty_of, domain=SlotDefinition, range=Optional[Union[str, SlotDefinitionName]])

slots.symmetric = Slot(uri=LINKML.symmetric, name="symmetric", curie=LINKML.curie('symmetric'),
                   model_uri=SCHEMA_EXTENSIONS.symmetric, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.inverse = Slot(uri=OWL.inverseOf, name="inverse", curie=OWL.curie('inverseOf'),
                   model_uri=SCHEMA_EXTENSIONS.inverse, domain=SlotDefinition, range=Optional[Union[str, SlotDefinitionName]])

slots.is_class_field = Slot(uri=LINKML.is_class_field, name="is_class_field", curie=LINKML.curie('is_class_field'),
                   model_uri=SCHEMA_EXTENSIONS.is_class_field, domain=SlotDefinition, range=Optional[Union[bool, Bool]])

slots.role = Slot(uri=LINKML.role, name="role", curie=LINKML.curie('role'),
                   model_uri=SCHEMA_EXTENSIONS.role, domain=SlotDefinition, range=Optional[str])

slots.minimum_value = Slot(uri=LINKML.minimum_value, name="minimum_value", curie=LINKML.curie('minimum_value'),
                   model_uri=SCHEMA_EXTENSIONS.minimum_value, domain=SlotDefinition, range=Optional[int])

slots.maximum_value = Slot(uri=LINKML.maximum_value, name="maximum_value", curie=LINKML.curie('maximum_value'),
                   model_uri=SCHEMA_EXTENSIONS.maximum_value, domain=SlotDefinition, range=Optional[int])

slots.pattern = Slot(uri=LINKML.pattern, name="pattern", curie=LINKML.curie('pattern'),
                   model_uri=SCHEMA_EXTENSIONS.pattern, domain=Definition, range=Optional[str])
...
slots.string_serialization = Slot(uri=LINKML.string_serialization, name="string_serialization", curie=LINKML.curie('string_serialization'),
                   model_uri=SCHEMA_EXTENSIONS.string_serialization, domain=Definition, range=Optional[str])

slots.typeof = Slot(uri=LINKML.typeof, name="typeof", curie=LINKML.curie('typeof'),
                   model_uri=SCHEMA_EXTENSIONS.typeof, domain=TypeDefinition, range=Optional[Union[str, TypeDefinitionName]])

slots.base = Slot(uri=LINKML.base, name="base", curie=LINKML.curie('base'),
                   model_uri=SCHEMA_EXTENSIONS.base, domain=TypeDefinition, range=Optional[str])

slots.type_uri = Slot(uri=LINKML.uri, name="type_uri", curie=LINKML.curie('uri'),
                   model_uri=SCHEMA_EXTENSIONS.type_uri, domain=TypeDefinition, range=Optional[Union[str, URIorCURIE]])

slots.repr = Slot(uri=LINKML.repr, name="repr", curie=LINKML.curie('repr'),
                   model_uri=SCHEMA_EXTENSIONS.repr, domain=TypeDefinition, range=Optional[str])

slots.alt_description_text = Slot(uri=LINKML.description, name="alt_description_text", curie=LINKML.curie('description'),
                   model_uri=SCHEMA_EXTENSIONS.alt_description_text, domain=AltDescription, range=str)

slots.alt_description_source = Slot(uri=LINKML.source, name="alt_description_source", curie=LINKML.curie('source'),
                   model_uri=SCHEMA_EXTENSIONS.alt_description_source, domain=AltDescription, range=Union[str, AltDescriptionSource])

slots.alt_descriptions = Slot(uri=LINKML.alt_descriptions, name="alt_descriptions", curie=LINKML.curie('alt_descriptions'),
                   model_uri=SCHEMA_EXTENSIONS.alt_descriptions, domain=Element, range=Optional[Union[Dict[Union[str, AltDescriptionSource], Union[dict, "AltDescription"]], List[Union[dict, "AltDescription"]]]])

slots.value = Slot(uri=SKOS.example, name="value", curie=SKOS.curie('example'),
                   model_uri=SCHEMA_EXTENSIONS.value, domain=Example, range=Optional[str])

slots.value_description = Slot(uri=LINKML.description, name="value_description", curie=LINKML.curie('description'),
                   model_uri=SCHEMA_EXTENSIONS.value_description, domain=Example, range=Optional[str])

slots.examples = Slot(uri=LINKML.examples, name="examples", curie=LINKML.curie('examples'),
                   model_uri=SCHEMA_EXTENSIONS.examples, domain=Element, range=Optional[Union[Union[dict, "Example"], List[Union[dict, "Example"]]]])

slots.prefix_prefix = Slot(uri=LINKML.prefix_prefix, name="prefix_prefix", curie=LINKML.curie('prefix_prefix'),
                   model_uri=SCHEMA_EXTENSIONS.prefix_prefix, domain=Prefix, range=Union[str, PrefixPrefixPrefix])

slots.prefix_reference = Slot(uri=LINKML.prefix_reference, name="prefix_reference", curie=LINKML.curie('prefix_reference'),
                   model_uri=SCHEMA_EXTENSIONS.prefix_reference, domain=Prefix, range=Union[str, URI])

slots.prefixes = Slot(uri=LINKML.prefixes, name="prefixes", curie=LINKML.curie('prefixes'),
                   model_uri=SCHEMA_EXTENSIONS.prefixes, domain=SchemaDefinition, range=Optional[Union[Dict[Union[str, PrefixPrefixPrefix], Union[dict, "Prefix"]], List[Union[dict, "Prefix"]]]])

slots.local_name_source = Slot(uri=LINKML.local_name_source, name="local_name_source", curie=LINKML.curie('local_name_source'),
                   model_uri=SCHEMA_EXTENSIONS.local_name_source, domain=LocalName, range=Union[str, LocalNameLocalNameSource])

slots.local_name_value = Slot(uri=SKOS.altLabel, name="local_name_value", curie=SKOS.curie('altLabel'),
                   model_uri=SCHEMA_EXTENSIONS.local_name_value, domain=LocalName, range=str)

slots.local_names = Slot(uri=LINKML.local_names, name="local_names", curie=LINKML.curie('local_names'),
                   model_uri=SCHEMA_EXTENSIONS.local_names, domain=Element, range=Optional[Union[Dict[Union[str, LocalNameLocalNameSource], Union[dict, "LocalName"]], List[Union[dict, "LocalName"]]]])

slots.ExtSchema_classes = Slot(uri=LINKML.classes, name="ExtSchema_classes", curie=LINKML.curie('classes'),
                   model_uri=SCHEMA_EXTENSIONS.ExtSchema_classes, domain=ExtSchema, range=Optional[Union[Dict[Union[str, ExtClassName], Union[dict, "ExtClass"]], List[Union[dict, "ExtClass"]]]])

slots.ExtSchema_slots = Slot(uri=LINKML.slots, name="ExtSchema_slots", curie=LINKML.curie('slots'),
                   model_uri=SCHEMA_EXTENSIONS.ExtSchema_slots, domain=ExtSchema, range=Optional[Union[Union[str, ExtSlotName], List[Union[str, ExtSlotName]]]])

slots.schema_definition_name = Slot(uri=RDFS.label, name="schema_definition_name", curie=RDFS.curie('label'),
                   model_uri=SCHEMA_EXTENSIONS.schema_definition_name, domain=SchemaDefinition, range=Union[str, SchemaDefinitionName], mappings = [SCHEMA.name])

slots.type_expression_any_of = Slot(uri=LINKML.any_of, name="type_expression_any_of", curie=LINKML.curie('any_of'),
                   model_uri=SCHEMA_EXTENSIONS.type_expression_any_of, domain=None, range=Optional[Union[Union[dict, "AnonymousTypeExpression"], List[Union[dict, "AnonymousTypeExpression"]]]])

slots.type_expression_all_of = Slot(uri=LINKML.all_of, name="type_expression_all_of", curie=LINKML.curie('all_of'),
                   model_uri=SCHEMA_EXTENSIONS.type_expression_all_of, domain=None, range=Optional[Union[Union[dict, "AnonymousTypeExpression"], List[Union[dict, "AnonymousTypeExpression"]]]])
...
slots.type_expression_exactly_one_of = Slot(uri=LINKML.exactly_one_of, name="type_expression_exactly_one_of", curie=LINKML.curie('exactly_one_of'),
                   model_uri=SCHEMA_EXTENSIONS.type_expression_exactly_one_of, domain=None, range=Optional[Union[Union[dict, "AnonymousTypeExpression"], List[Union[dict, "AnonymousTypeExpression"]]]])

slots.type_expression_none_of = Slot(uri=LINKML.none_of, name="type_expression_none_of", curie=LINKML.curie('none_of'),
                   model_uri=SCHEMA_EXTENSIONS.type_expression_none_of, domain=None, range=Optional[Union[Union[dict, "AnonymousTypeExpression"], List[Union[dict, "AnonymousTypeExpression"]]]])

slots.slot_expression_any_of = Slot(uri=LINKML.any_of, name="slot_expression_any_of", curie=LINKML.curie('any_of'),
                   model_uri=SCHEMA_EXTENSIONS.slot_expression_any_of, domain=None, range=Optional[Union[Union[dict, "AnonymousSlotExpression"], List[Union[dict, "AnonymousSlotExpression"]]]])

slots.slot_expression_all_of = Slot(uri=LINKML.all_of, name="slot_expression_all_of", curie=LINKML.curie('all_of'),
                   model_uri=SCHEMA_EXTENSIONS.slot_expression_all_of, domain=None, range=Optional[Union[Union[dict, "AnonymousSlotExpression"], List[Union[dict, "AnonymousSlotExpression"]]]])
...
slots.slot_expression_exactly_one_of = Slot(uri=LINKML.exactly_one_of, name="slot_expression_exactly_one_of", curie=LINKML.curie('exactly_one_of'),
                   model_uri=SCHEMA_EXTENSIONS.slot_expression_exactly_one_of, domain=None, range=Optional[Union[Union[dict, "AnonymousSlotExpression"], List[Union[dict, "AnonymousSlotExpression"]]]])

slots.slot_expression_none_of = Slot(uri=LINKML.none_of, name="slot_expression_none_of", curie=LINKML.curie('none_of'),
                   model_uri=SCHEMA_EXTENSIONS.slot_expression_none_of, domain=None, range=Optional[Union[Union[dict, "AnonymousSlotExpression"], List[Union[dict, "AnonymousSlotExpression"]]]])

slots.slot_definition_is_a = Slot(uri=LINKML.is_a, name="slot_definition_is_a", curie=LINKML.curie('is_a'),
                   model_uri=SCHEMA_EXTENSIONS.slot_definition_is_a, domain=SlotDefinition, range=Optional[Union[str, SlotDefinitionName]])

slots.slot_definition_mixins = Slot(uri=LINKML.mixins, name="slot_definition_mixins", curie=LINKML.curie('mixins'),
                   model_uri=SCHEMA_EXTENSIONS.slot_definition_mixins, domain=SlotDefinition, range=Optional[Union[Union[str, SlotDefinitionName], List[Union[str, SlotDefinitionName]]]])

slots.slot_definition_apply_to = Slot(uri=LINKML.apply_to, name="slot_definition_apply_to", curie=LINKML.curie('apply_to'),
                   model_uri=SCHEMA_EXTENSIONS.slot_definition_apply_to, domain=SlotDefinition, range=Optional[Union[Union[str, SlotDefinitionName], List[Union[str, SlotDefinitionName]]]])

slots.class_expression_any_of = Slot(uri=LINKML.any_of, name="class_expression_any_of", curie=LINKML.curie('any_of'),
                   model_uri=SCHEMA_EXTENSIONS.class_expression_any_of, domain=None, range=Optional[Union[Union[dict, "AnonymousClassExpression"], List[Union[dict, "AnonymousClassExpression"]]]])

slots.class_expression_all_of = Slot(uri=LINKML.all_of, name="class_expression_all_of", curie=LINKML.curie('all_of'),
                   model_uri=SCHEMA_EXTENSIONS.class_expression_all_of, domain=None, range=Optional[Union[Union[dict, "AnonymousClassExpression"], List[Union[dict, "AnonymousClassExpression"]]]])
...
slots.class_expression_exactly_one_of = Slot(uri=LINKML.exactly_one_of, name="class_expression_exactly_one_of", curie=LINKML.curie('exactly_one_of'),
                   model_uri=SCHEMA_EXTENSIONS.class_expression_exactly_one_of, domain=None, range=Optional[Union[Union[dict, "AnonymousClassExpression"], List[Union[dict, "AnonymousClassExpression"]]]])

slots.class_expression_none_of = Slot(uri=LINKML.none_of, name="class_expression_none_of", curie=LINKML.curie('none_of'),
                   model_uri=SCHEMA_EXTENSIONS.class_expression_none_of, domain=None, range=Optional[Union[Union[dict, "AnonymousClassExpression"], List[Union[dict, "AnonymousClassExpression"]]]])

slots.class_definition_is_a = Slot(uri=LINKML.is_a, name="class_definition_is_a", curie=LINKML.curie('is_a'),
                   model_uri=SCHEMA_EXTENSIONS.class_definition_is_a, domain=ClassDefinition, range=Optional[Union[str, ClassDefinitionName]])

slots.class_definition_mixins = Slot(uri=LINKML.mixins, name="class_definition_mixins", curie=LINKML.curie('mixins'),
                   model_uri=SCHEMA_EXTENSIONS.class_definition_mixins, domain=ClassDefinition, range=Optional[Union[Union[str, ClassDefinitionName], List[Union[str, ClassDefinitionName]]]])

slots.class_definition_apply_to = Slot(uri=LINKML.apply_to, name="class_definition_apply_to", curie=LINKML.curie('apply_to'),
                   model_uri=SCHEMA_EXTENSIONS.class_definition_apply_to, domain=ClassDefinition, range=Optional[Union[Union[str, ClassDefinitionName], List[Union[str, ClassDefinitionName]]]])

slots.class_definition_rules = Slot(uri=SH.rule, name="class_definition_rules", curie=SH.curie('rule'),
                   model_uri=SCHEMA_EXTENSIONS.class_definition_rules, domain=ClassDefinition, range=Optional[Union[Union[dict, "ClassRule"], List[Union[dict, "ClassRule"]]]])

slots.permissible_value_is_a = Slot(uri=LINKML.is_a, name="permissible_value_is_a", curie=LINKML.curie('is_a'),
                   model_uri=SCHEMA_EXTENSIONS.permissible_value_is_a, domain=PermissibleValue, range=Optional[Union[str, PermissibleValueText]])

slots.permissible_value_mixins = Slot(uri=LINKML.mixins, name="permissible_value_mixins", curie=LINKML.curie('mixins'),
                   model_uri=SCHEMA_EXTENSIONS.permissible_value_mixins, domain=PermissibleValue, range=Optional[Union[Union[str, PermissibleValueText], List[Union[str, PermissibleValueText]]]])
