...
class ContextUtilsTestCase(unittest.TestCase):
    def test_merge_contexts(self):
        ...
        self.assertEqual(loads(context_output), merge_contexts(["local.jsonld", METAMODEL_CONTEXT_URI, json_1, json_2]))
    ...
    def test_merge_contexts_base(self):
        self.assertEqual(
            JsonObj(**{"@context": JsonObj(**{"@base": "file://relloc"})}), merge_contexts(base="file://relloc")
        )
